import { defineComponent as o, resolveComponent as p, createElementBlock as _, openBlock as t, createVNode as h, mergeProps as M, withCtx as i, Fragment as f, renderList as x, createBlock as v, createCommentVNode as u, createElementVNode as a, resolveDynamicComponent as d, toDisplayString as g, useAttrs as C, isVNode as z } from "vue";
const H = { class: "" }, V = /* @__PURE__ */ o({
  __name: "index",
  props: {
    data: {
      type: Array,
  ...
  setup(e) {
    return (r, l) => {
      const m = p("el-menu-item"), s = p("el-sub-menu"), c = p("el-menu");
      return t(), _("div", H, [
        h(c, M({ "default-active": e.defaultActive }, r.$attrs, {
          router: e.router,
          ...
          default: i(() => [
            (t(!0), _(
              ...
              x(e.data, (n) => (t(), _(
                ...
                null,
                [
                  !n[e.childrenKey] || !n[e.childrenKey].length ? (t(), v(m, {
                    index: n[e.indexKey],
                    key: n[e.labelKey]
                  }, {
                    default: i(() => [
                      n[e.iconKey] ? (t(), v(d(`el-icon-${r.toLine(n[e.iconKey])}`), {
                        key: 0,
                        class: "mr-[4px]"
                      })) : u("v-if", !0),
                      a(
                  ...
                  n[e.childrenKey] && n[e.childrenKey].length ? (t(), v(s, {
                    index: n[e.indexKey],
                    key: n[e.labelKey]
                  }, {
                    title: i(() => [
                    ...
                    default: i(() => [
                      (t(!0), _(
                        f,
                        null,
                        x(n[e.childrenKey], (w) => (t(), v(m, {
                          index: w.index,
                          key: w.name
                        }, {
                          default: i(() => [
                            w[e.iconKey] ? (t(), v(d(`el-icon-${r.toLine(n[e.iconKey])}`), {
                              key: 0,
                              class: "mr-[4px]"
                            })) : u("v-if", !0),
                            a(
  ...
  for (const [m, s] of r)
    l[m] = s;
  return l;
}, L = /* @__PURE__ */ B(V, [["__scopeId", "data-v-363d4f0f"]]);
var A = /* @__PURE__ */ o({
  name: "AddLocation",
  __name: "add-location",
  setup(e) {
...
const xe = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  ChromeFilled: p0,
  CircleCheck: f0,
  CircleCheckFilled: u0,
  CircleClose: M0,
  CircleCloseFilled: g0,
  CirclePlus: V0,
  CirclePlusFilled: z0,
  Clock: L0,
  Close: q0,
  ...
  Van: U9,
  VideoCamera: Q9,
  VideoCameraFilled: E9,
  VideoPause: $9,
  VideoPlay: J9,
  View: Y9,
  Wallet: re,
  WalletFilled: ee,
  WarnTriangleFilled: _e,
  Warning: se,
  WarningFilled: ne,
  Watch: me,
  Watermelon: pe,
...
const Ce = /* @__PURE__ */ o({
  ...
  setup(e, r) {
    const l = C(), m = (s) => s.map((c) => {
      c.i = xe[c[e.iconKey]];
      const n = {
        title: () => h(f, null, [h(c.i, {
          class: "mr-4"
        }, null), h("span", null, [c[e.labelKey]])])
      };
      return c[e.childrenKey] && c[e.childrenKey].length ? h(p("el-sub-menu"), {
        index: c[e.indexKey]
      }, {
        default: () => [m(c[e.childrenKey])],
        ...n
      }) : h(p("el-menu-item"), {
        index: c[e.indexKey]
      }, {
        default: () => [h(c.i, null, null), h("span", null, [c[e.labelKey]])]
      });
    });
    return () => {
      let s;
      return h(p("el-menu"), M({
  ...
  install(e) {
    e.component("ti-leftmenu", L), e.component("ti-infinite-leftmenu", Ce);
  }
};
export {
  He as default
