...
import { defineComponent as x, resolveComponent as r, createElementBlock as h, openBlock as t, createVNode as m, mergeProps as $, withCtx as i, Fragment as f, renderList as C, createBlock as o, createCommentVNode as p, createElementVNode as y, resolveDynamicComponent as g, toDisplayString as v, reactive as w, ref as B } from "vue";
const R = { class: "" }, L = /* @__PURE__ */ x({
          ...
          default: i(() => [
            (t(!0), h(
              ...
              C(e.data, (n) => (t(), h(
                ...
                null,
                [
                  !n[e.childrenKey] || !n[e.childrenKey].length ? (t(), o(a, {
                    index: n[e.indexKey],
                    key: n[e.labelKey]
                  }, {
                    default: i(() => [
                      n[e.iconKey] ? (t(), o(g(`el-icon-${l.toLine(n[e.iconKey])}`), {
                        key: 0,
                        class: "mr-[4px]"
                      })) : p("v-if", !0),
                      y(
                  ...
                  n[e.childrenKey] && n[e.childrenKey].length ? (t(), o(d, {
                    index: n[e.indexKey],
                    key: n[e.labelKey]
                  }, {
                    title: i(() => [
                    ...
                    default: i(() => [
                      (t(!0), h(
                        f,
                        null,
                        C(n[e.childrenKey], (s) => (t(), o(a, {
                          index: s.index,
                          key: s.name
                        }, {
                          default: i(() => [
                            s[e.iconKey] ? (t(), o(g(`el-icon-${l.toLine(n[e.iconKey])}`), {
                              key: 0,
                              class: "mr-[4px]"
                            })) : p("v-if", !0),
                            y(
  ...
  for (const [a, d] of l)
    c[a] = d;
  return c;
}, N = /* @__PURE__ */ _(L, [["__scopeId", "data-v-1362b4bc"]]), A = /* @__PURE__ */ x({
  __name: "index",
  props: {
    isCollapse: {
      type: Boolean,
  ...
  setup(e, { emit: l }) {
    ...
    return (d, u) => {
      ...
      return t(), o(k, { class: "header" }, {
        default: i(() => [
          y("div", {
            class: "w-[100px]",
            onClick: u[0] || (u[0] = () => a("collapseChange", !c.isCollapse))
          }, [
            c.isCollapse ? (t(), o(n, { key: 0 })) : (t(), o(s, { key: 1 }))
          ])
        ]),
        _: 1
        /* STABLE */
...
}), E = [
  {
    ...
    children: [
      {
        path: "",
        component: () => import("./Home-Br_TdUMp.js"),
        meta: {
          title: "首页",
      ...
      {
        path: "/trend",
        component: () => import("./Trend-DN-erQ-5.js"),
        meta: {
          title: "图标选择器",
          icon: "el-icon-rice-ag"
        }
      ...
      {
        path: "/progress",
        component: () => import("./Progress-fBlwmUFF.js"),
        meta: {
          title: "进度条",
          icon: "el-icon-rice-ag"
        }
      ...
      {
        path: "/table",
        component: () => import("./Table-BLLl4YJA.js"),
        meta: {
          title: "表格组件",
          icon: "el-icon-rice-ag"
        }
