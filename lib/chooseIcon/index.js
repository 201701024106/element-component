import { defineComponent as o, createElementBlock as n, openBlock as l, createElementVNode as r, getCurrentInstance as N, inject as D, ref as y, computed as d, unref as u, readonly as k0, getCurrentScope as O0, onScopeDispose as P0, onMounted as j2, nextTick as U2, watch as r2, isRef as T0, warn as F0, provide as q0, mergeProps as D0, renderSlot as $, normalizeClass as b, createVNode as I, Transition as G2, withCtx as S, withDirectives as K2, normalizeStyle as W2, createTextVNode as I0, toDisplayString as e2, vShow as Z2, shallowReactive as Q2, createBlock as q, createCommentVNode as Y, resolveDynamicComponent as J2, Fragment as Y2, withModifiers as E0, isVNode as X2, render as B2, resolveComponent as s2, renderList as N0 } from "vue";
var $0 = /* @__PURE__ */ o({
  name: "AddLocation",
  __name: "add-location",
  setup(e) {
...
const b9 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  ChromeFilled: y4,
  CircleCheck: S4,
  CircleCheckFilled: b4,
  CircleClose: P4,
  CircleCloseFilled: e0,
  CirclePlus: D4,
  CirclePlusFilled: F4,
  Clock: E4,
  Close: a0,
  ...
  Van: X5,
  VideoCamera: r9,
  VideoCameraFilled: a9,
  VideoPause: o9,
  VideoPlay: s9,
  View: _9,
  Wallet: m9,
  WalletFilled: p9,
  WarnTriangleFilled: v9,
  Warning: f9,
  WarningFilled: r0,
  Watch: x9,
  Watermelon: M9,
  ...
  ZoomIn: B9,
  ZoomOut: L9
}, Symbol.toStringTag, { value: "Module" })), G = (e) => e.replace(new RegExp("(?<!^)([A-Z])", "g"), "-$1").toLowerCase(), l0 = Symbol(), X = "el", A9 = "is-", A = (e, t, a, s, c) => {
  let i = `${e}-${t}`;
  return a && (i += `-${a}`), s && (i += `__${s}`), c && (i += `--${c}`), i;
}, o0 = Symbol("namespaceContextKey"), S9 = (e) => {
  const t = e || (N() ? D(o0, y(X)) : y(X));
  return d(() => u(t) || X);
}, h2 = (e, t) => {
  const a = S9(t);
  return {
    ...
    e: (m) => m ? A(a.value, e, "", m, "") : "",
    m: (m) => m ? A(a.value, e, "", "", m) : "",
    be: (m, f) => m && f ? A(a.value, e, m, f, "") : "",
    em: (m, f) => m && f ? A(a.value, e, "", m, f) : "",
    bm: (m, f) => m && f ? A(a.value, e, m, "", f) : "",
    bem: (m, f, M) => m && f && M ? A(a.value, e, m, f, M) : "",
    is: (m, ...f) => {
      const M = f.length >= 1 ? f[0] : !0;
      return m && M ? `${A9}${m}` : "";
    },
    cssVar: (m) => {
      const f = {};
...
process.env.NODE_ENV !== "production" && Object.freeze([]);
const k9 = Object.prototype.hasOwnProperty, p2 = (e, t) => k9.call(e, t), O9 = Array.isArray, a2 = (e) => typeof e == "function", j = (e) => typeof e == "string", n0 = (e) => e !== null && typeof e == "object";
var P9 = typeof global == "object" && global && global.Object === Object && global, T9 = typeof self == "object" && self && self.Object === Object && self, v2 = P9 || T9 || Function("return this")(), R = v2.Symbol, s0 = Object.prototype, F9 = s0.hasOwnProperty, q9 = s0.toString, K = R ? R.toStringTag : void 0;
function D9(e) {
  var t = F9.call(e, K), a = e[K];
  try {
    e[K] = void 0;
    var s = !0;
  } catch {
  ...
  var c = q9.call(e);
  return s && (t ? e[K] = a : delete e[K]), c;
}
var I9 = Object.prototype, E9 = I9.toString;
function N9(e) {
  return E9.call(e);
}
var $9 = "[object Null]", R9 = "[object Undefined]", y2 = R ? R.toStringTag : void 0;
function c0(e) {
  return e == null ? e === void 0 ? R9 : $9 : y2 && y2 in Object(e) ? D9(e) : N9(e);
}
function j9(e) {
  return e != null && typeof e == "object";
}
var U9 = "[object Symbol]";
function d2(e) {
  return typeof e == "symbol" || j9(e) && c0(e) == U9;
}
function G9(e, t) {
  for (var a = -1, s = e == null ? 0 : e.length, c = Array(s); ++a < s; )
    c[a] = t(e[a], a, e);
  return c;
}
var w2 = Array.isArray, L2 = R ? R.prototype : void 0, b2 = L2 ? L2.toString : void 0;
function _0(e) {
  if (typeof e == "string")
    return e;
  if (w2(e))
...
var K9 = "[object AsyncFunction]", W9 = "[object Function]", Z9 = "[object GeneratorFunction]", Q9 = "[object Proxy]";
function J9(e) {
  if (!i0(e))
    return !1;
  var t = c0(e);
  return t == W9 || t == Z9 || t == K9 || t == Q9;
}
var c2 = v2["__core-js_shared__"], A2 = (function() {
...
var X9 = Function.prototype, el = X9.toString;
function al(e) {
  if (e != null) {
    try {
      return el.call(e);
...
var tl = /[\\^$.*+?()[\]{}|]/g, rl = /^\[object .+?Constructor\]$/, ll = Function.prototype, ol = Object.prototype, nl = ll.toString, sl = ol.hasOwnProperty, cl = RegExp(
  "^" + nl.call(sl).replace(tl, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
);
function _l(e) {
  if (!i0(e) || Y9(e))
    return !1;
...
function hl(e, t) {
  if (w2(e))
    return !1;
  var a = typeof e;
  return a == "number" || a == "symbol" || a == "boolean" || e == null || d2(e) ? !0 : ml.test(e) || !ul.test(e) || t != null && e in Object(t);
}
var W = p0(Object, "create");
function vl() {
...
var wl = "__lodash_hash_undefined__", fl = Object.prototype, gl = fl.hasOwnProperty;
function xl(e) {
  var t = this.__data__;
  if (W) {
    var a = t[e];
    return a === wl ? void 0 : a;
  }
  return gl.call(t, e) ? t[e] : void 0;
}
var Cl = Object.prototype, Ml = Cl.hasOwnProperty;
function zl(e) {
  var t = this.__data__;
  return W ? t[e] !== void 0 : Ml.call(t, e);
}
var Hl = "__lodash_hash_undefined__";
function Vl(e, t) {
  var a = this.__data__;
  return this.size += this.has(e) ? 0 : 1, a[e] = W && t === void 0 ? Hl : t, this;
}
function k(e) {
...
k.prototype.clear = vl;
k.prototype.delete = dl;
k.prototype.get = xl;
k.prototype.has = zl;
k.prototype.set = Vl;
function Bl() {
...
var yl = Array.prototype, Ll = yl.splice;
function bl(e) {
  var t = this.__data__, a = l2(t, e);
  if (a < 0)
    return !1;
  var s = t.length - 1;
  return a == s ? t.pop() : Ll.call(t, a, 1), --this.size, !0;
}
function Al(e) {
  var t = this.__data__, a = l2(t, e);
...
U.prototype.clear = Bl;
U.prototype.delete = bl;
U.prototype.get = Al;
U.prototype.has = Sl;
U.prototype.set = kl;
var Ol = p0(v2, "Map");
...
T.prototype.clear = Pl;
T.prototype.delete = Fl;
T.prototype.get = ql;
T.prototype.has = Dl;
T.prototype.set = Il;
...
function f2(e, t) {
  ...
  var a = function() {
    var s = arguments, c = t ? t.apply(this, s) : s[0], i = a.cache;
    if (i.has(c))
      return i.get(c);
    var _ = e.apply(this, s);
    return a.cache = i.set(c, _) || i, _;
  };
  return a.cache = new (f2.Cache || T)(), a;
}
f2.Cache = T;
var Nl = 500;
function $l(e) {
  var t = f2(e, function(s) {
    return a.size === Nl && a.clear(), s;
  }), a = t.cache;
  return t;
}
var Rl = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, jl = /\\(\\)?/g, Ul = $l(function(e) {
  var t = [];
  return e.charCodeAt(0) === 46 && t.push(""), e.replace(Rl, function(a, s, c, i) {
    t.push(c ? i.replace(jl, "$1") : s || a);
  }), t;
});
function Gl(e) {
  return e == null ? "" : _0(e);
...
function Kl(e, t) {
  return w2(e) ? e : hl(e, t) ? [e] : Ul(Gl(e));
}
function Wl(e) {
...
const Yl = (e) => e === void 0, _2 = (e) => typeof e == "boolean", O = (e) => typeof e == "number", Xl = (e) => typeof Element > "u" ? !1 : e instanceof Element, eo = (e) => j(e) ? !Number.isNaN(Number(e)) : !1;
var S2;
const F = typeof window < "u", ao = (e) => typeof e == "string", to = () => {
};
F && ((S2 = window?.navigator) != null && S2.userAgent) && /iP(ad|hone|od)/.test(window.navigator.userAgent);
function g2(e) {
...
function oo(e, t, a = {}) {
  ...
  function h(...x) {
    _(), c.value = !0, i = setTimeout(() => {
      c.value = !1, i = null, e(...x);
    }, g2(t));
  }
  return s && (c.value = !0, F && h()), x2(p), {
    isPending: k0(c),
    start: h,
    stop: p
  };
...
const m0 = F ? window : void 0;
function no(...e) {
  let t, a, s, c;
  if (ao(e[0]) || Array.isArray(e[0]) ? ([a, s, c] = e, t = m0) : [t, a, s, c] = e, !t)
    return to;
  Array.isArray(a) || (a = [a]), Array.isArray(s) || (s = [s]);
  const i = [], _ = () => {
    i.forEach((v) => v()), i.length = 0;
  }, p = (v, g, B, C) => (v.addEventListener(g, B, C), () => v.removeEventListener(g, B, C)), h = r2(() => [u0(t), g2(c)], ([v, g]) => {
    _(), v && i.push(...a.flatMap((B) => s.map((C) => p(v, B, C, g))));
...
function so(e, t = !1) {
  const a = y(), s = () => a.value = !!e();
  return s(), lo(s, t), a;
}
const k2 = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, O2 = "__vueuse_ssr_handlers__";
k2[O2] = k2[O2] || {};
var P2 = Object.getOwnPropertySymbols, co = Object.prototype.hasOwnProperty, _o = Object.prototype.propertyIsEnumerable, io = (e, t) => {
  var a = {};
  for (var s in e)
    co.call(e, s) && t.indexOf(s) < 0 && (a[s] = e[s]);
  if (e != null && P2)
    for (var s of P2(e))
      t.indexOf(s) < 0 && _o.call(e, s) && (a[s] = e[s]);
  return a;
};
function po(e, t, a = {}) {
  const s = a, { window: c = m0 } = s, i = io(s, ["window"]);
  let _;
  const p = so(() => c && "ResizeObserver" in c), h = () => {
    _ && (_.disconnect(), _ = void 0);
  }, x = r2(() => u0(e), (g) => {
    h(), p.value && c && g && (_ = new ResizeObserver(t), _.observe(g, i));
...
var uo = Object.defineProperty, F2 = Object.getOwnPropertySymbols, mo = Object.prototype.hasOwnProperty, ho = Object.prototype.propertyIsEnumerable, q2 = (e, t, a) => t in e ? uo(e, t, { enumerable: !0, configurable: !0, writable: !0, value: a }) : e[t] = a, vo = (e, t) => {
  for (var a in t || (t = {}))
    mo.call(t, a) && q2(e, a, t[a]);
  if (F2)
    for (var a of F2(t))
      ho.call(t, a) && q2(e, a, t[a]);
  return e;
};
const wo = {
...
function Z(e, t) {
  const a = j(e) ? new fo(`[${e}] ${t}`) : e;
  console.warn(a);
}
const D2 = {
  current: 0
}, I2 = y(0), h0 = 2e3, E2 = Symbol("elZIndexContextKey"), v0 = Symbol("zIndexContextKey"), go = (e) => {
  const t = N() ? D(E2, D2) : D2, a = e || (N() ? D(v0, void 0) : void 0), s = d(() => {
    const _ = u(a);
    return O(_) ? _ : h0;
  }), c = d(() => s.value + I2.value), i = () => (t.current++, I2.value = t.current, c.value);
  return !F && !D(E2) && Z("ZIndexInjection", `Looks like you are using server rendering, you must provide a z-index provider to ensure the hydration process to be succeed
...
const Co = (e) => (t, a) => Mo(t, a, u(e)), Mo = (e, t, a) => Ql(a, e, e).replace(/\{(\w+)\}/g, (s, c) => {
  var i;
  return `${(i = t?.[c]) != null ? i : `{${c}}`}`;
}), zo = (e) => {
  const t = d(() => u(e).name), a = T0(e) ? e : y(e);
  return {
    lang: t,
    locale: a,
    t: Co(e)
  };
}, d0 = Symbol("localeContextKey"), Ho = (e) => {
  const t = e || D(d0, y());
  return zo(d(() => t.value || xo));
}, w0 = "__epPropKey", V = (e) => e, Vo = (e) => n0(e) && !!e[w0], f0 = (e, t) => {
  if (!n0(e) || Vo(e))
    return e;
  const { values: a, required: s, default: c, type: i, validator: _ } = e, h = {
    type: i,
    required: !!s,
    validator: a || _ ? (x) => {
      let v = !1, g = [];
      if (a && (g = Array.from(a), p2(e, "default") && g.push(c), v || (v = g.includes(x))), _ && (v || (v = _(x))), !v && g.length > 0) {
        const B = [...new Set(g)].map((C) => JSON.stringify(C)).join(", ");
        F0(`Invalid prop: validation failed${t ? ` for prop "${t}"` : ""}. Expected one of [${B}], got value ${JSON.stringify(x)}.`);
      }
      return v;
    } : void 0,
    [w0]: !0
  };
  return p2(e, "default") && (h.default = c), h;
}, Q = (e) => Jl(Object.entries(e).map(([t, a]) => [
  t,
  f0(a, t)
])), Bo = ["", "default", "small", "large"], yo = f0({
  type: String,
  values: Bo,
  required: !1
}), Lo = Symbol("size"), bo = Symbol("emptyValuesContextKey"), Ao = Q({
  emptyValues: Array,
  valueOnClear: {
    type: V([
      String,
    ...
    default: void 0,
    validator: (e) => (e = a2(e) ? e() : e, O9(e) ? e.every((t) => !t) : !e)
  }
}), N2 = (e) => Object.keys(e), t2 = y();
function g0(e, t = void 0) {
  return N() ? D(l0, t2) : t2;
}
function So(e, t) {
  const a = g0(), s = h2(e, d(() => {
    var p;
    return ((p = a.value) == null ? void 0 : p.namespace) || X;
  })), c = Ho(d(() => {
    var p;
    return (p = a.value) == null ? void 0 : p.locale;
  })), i = go(d(() => {
    var p;
    return ((p = a.value) == null ? void 0 : p.zIndex) || h0;
  })), _ = d(() => {
    var p;
    return u(t) || ((p = a.value) == null ? void 0 : p.size) || "";
  });
  return x0(d(() => u(a) || {})), {
    ns: s,
    locale: c,
...
const x0 = (e, t, a = !1) => {
  var s;
  const c = !!N(), i = c ? g0() : void 0, _ = (s = void 0) != null ? s : c ? q0 : void 0;
  if (!_) {
  ...
  const p = d(() => {
    const h = u(e);
    return i?.value ? ko(i.value, h) : h;
  });
  return _(l0, p), _(d0, d(() => p.value.locale)), _(o0, d(() => p.value.namespace)), _(v0, d(() => p.value.zIndex)), _(Lo, {
    size: d(() => p.value.size || "")
  }), _(bo, d(() => ({
    emptyValues: p.value.emptyValues,
    valueOnClear: p.value.valueOnClear
  }))), (a || !t2.value) && (t2.value = p.value), p;
}, ko = (e, t) => {
  const a = [.../* @__PURE__ */ new Set([...N2(e), ...N2(t)])], s = {};
  for (const c of a)
    s[c] = t[c] !== void 0 ? t[c] : e[c];
  return s;
};
var C2 = (e, t) => {
...
function u2(e, t = "px") {
  ...
  if (j(e))
    return e;
  Z(Oo, "binding value must be a string or number");
}
const C0 = (e, t) => (e.install = (a) => {
  for (const s of [e, ...Object.values({})])
    a.component(s.name, s);
}, e), Po = (e, t) => (e.install = (a) => {
  ...
  props: To,
  setup(e) {
    const t = e, a = h2("icon"), s = d(() => {
      const { size: c, color: i } = t;
      return !c && !i ? {} : {
        fontSize: Yl(c) ? void 0 : u2(c),
        "--color": i
      };
    });
    return (c, i) => (l(), n("i", D0({
...
var Do = /* @__PURE__ */ C2(qo, [["__file", "icon.vue"]]);
const $2 = C0(Do), Io = V([
  String,
  Object,
  Function
  ...
  error: e0,
  info: i2
}, No = () => F && /android/i.test(window.navigator.userAgent), $o = (e) => e, m2 = {
  tab: "Tab",
  enter: "Enter",
  space: "Space",
  left: "ArrowLeft",
  ...
  const t = jo(e);
  if (t) {
    if (Object.values(m2).includes(t))
      return t;
    switch (t) {
      case " ":
        return m2.space;
  ...
  if (!t && e.type === "keyup" && No()) {
    const a = e.target;
    t = a.value.charAt(a.selectionStart - 1);
  }
  return t;
}, Uo = Q({
  value: {
  ...
  props: Uo,
  setup(e, { expose: t }) {
    const a = e, s = h2("badge"), c = d(() => a.isDot ? "" : O(a.value) && O(a.max) ? a.max < a.value ? `${a.max}+` : `${a.value}` : `${a.value}`), i = d(() => {
      var _, p, h, x, v;
      return [
        {
          backgroundColor: a.color,
          marginRight: u2(-((p = (_ = a.offset) == null ? void 0 : _[0]) != null ? p : 0)),
          marginTop: u2((x = (h = a.offset) == null ? void 0 : h[1]) != null ? x : 0)
        },
        (v = a.badgeStyle) != null ? v : {}
      ];
    });
    return t({
      content: c
      ...
      I(G2, {
        ...
        default: S(() => [
          K2(r("sup", {
            class: b([
              u(s).e("content"),
              u(s).em("content", _.type),
              u(s).is("fixed", !!_.$slots.default),
              u(s).is("dot", _.isDot),
              u(s).is("hide-zero", !_.showZero && _.value === 0),
              _.badgeClass
            ]),
            style: W2(u(i))
          }, [
            $(_.$slots, "content", { value: u(c) }, () => [
              I0(e2(u(c)), 1)
            ])
          ], 6), [
            [Z2, !_.hidden && (u(c) || _.isDot || _.$slots.content)]
          ])
        ]),
        _: 3
      }, 8, ["name"])
...
var Wo = /* @__PURE__ */ C2(Ko, [["__file", "badge.vue"]]);
const Zo = C0(Wo), Qo = Q({
  a11y: {
    type: Boolean,
    default: !0
...
o({
  ...
  setup(e, { slots: t }) {
    const a = x0(e);
    return r2(() => e.message, (s) => {
      var c, i;
      Object.assign(H, (i = (c = a?.value) == null ? void 0 : c.message) != null ? i : {}, s ?? {});
    }, { immediate: !0, deep: !0 }), () => $(t, "default", { config: a?.value });
  }
});
const M0 = [
  "primary",
  ...
  destroy: () => !0
}, L = Q2({}), Xo = (e) => (L[e] || (L[e] = Q2([])), L[e]), en = (e, t) => {
  const a = L[t] || [], s = a.findIndex((_) => _.id === e), c = a[s];
  let i;
  return s > 0 && (i = a[s - 1]), { current: c, prev: i };
}, an = (e, t) => {
  const { prev: a } = en(e, t);
  return a ? a.vm.exposed.bottom.value : 0;
}, tn = (e, t, a) => (L[a] || []).findIndex((i) => i.id === e) > 0 ? 16 : t, rn = o({
  name: "ElMessage"
}), ln = /* @__PURE__ */ o({
  ...rn,
  props: Jo,
  ...
  setup(e, { expose: t, emit: a }) {
    const s = e, { Close: c } = Eo, i = y(!1), { ns: _, zIndex: p } = So("message"), { currentZIndex: h, nextZIndex: x } = p, v = y(), g = y(!1), B = y(0);
    let C;
    const M2 = d(() => s.type ? s.type === "error" ? "danger" : s.type : "info"), m = d(() => {
      const w = s.type;
      return { [_.bm("icon", w)]: w && R2[w] };
    }), f = d(() => s.icon || R2[s.type] || ""), M = d(() => s.placement || E), V0 = d(() => an(s.id, M.value)), z2 = d(() => tn(s.id, s.offset, M.value) + V0.value), B0 = d(() => B.value + z2.value), y0 = d(() => M.value.includes("left") ? _.is("left") : M.value.includes("right") ? _.is("right") : _.is("center")), H2 = d(() => M.value.startsWith("top") ? "top" : "bottom"), L0 = d(() => ({
      [H2.value]: `${z2.value}px`,
      zIndex: h.value
    }));
    function n2() {
      s.duration !== 0 && ({ stop: C } = oo(() => {
        J();
      }, s.duration));
    }
    function V2() {
    ...
    function J() {
      g.value = !1, U2(() => {
        var w;
        i.value || ((w = s.onClose) == null || w.call(s), a("destroy"));
      });
    }
    function b0(w) {
      Ro(w) === m2.esc && J();
    ...
    return j2(() => {
      ...
      V2(), n2();
    }), no(document, "keydown", b0), po(v, () => {
      B.value = v.value.getBoundingClientRect().height;
    }), t({
      visible: g,
      bottom: B0,
      close: J
      ...
      name: u(_).b("fade"),
      onBeforeEnter: (S0) => i.value = !0,
      onBeforeLeave: w.onClose,
      onAfterLeave: (S0) => w.$emit("destroy"),
      persisted: ""
    }, {
      default: S(() => [
        K2(r("div", {
          ...
          class: b([
            u(_).b(),
            { [u(_).m(w.type)]: w.type },
            u(_).is("closable", w.showClose),
            u(_).is("plain", w.plain),
            u(_).is("bottom", u(H2) === "bottom"),
            u(y0),
            w.customClass
          ]),
          style: W2(u(L0)),
...
var on = /* @__PURE__ */ C2(ln, [["__file", "message.vue"]]);
let nn = 1;
const sn = (e) => {
  if (!e.appendTo)
    ...
    Xl(a) || (Z("ElMessage", "the appendTo option is not an HTMLElement. Falling back to document.body."), a = document.body), e.appendTo = a;
  }
}, cn = (e) => {
  !e.placement && j(H.placement) && H.placement && (e.placement = H.placement), e.placement || (e.placement = E), z0.includes(e.placement) || (Z("ElMessage", `Invalid placement: ${e.placement}. Falling back to '${E}'.`), e.placement = E);
}, H0 = (e) => {
  const t = !e || j(e) || X2(e) || a2(e) ? { message: e } : e, a = {
    ...z,
    ...t
  };
  return sn(a), cn(a), _2(H.grouping) && !a.grouping && (a.grouping = H.grouping), O(H.duration) && a.duration === 3e3 && (a.duration = H.duration), O(H.offset) && a.offset === 16 && (a.offset = H.offset), _2(H.showClose) && !a.showClose && (a.showClose = H.showClose), _2(H.plain) && !a.plain && (a.plain = H.plain), a;
}, _n = (e) => {
  const t = e.props.placement || E, a = L[t], s = a.indexOf(e);
  if (s === -1)
    return;
  a.splice(s, 1);
  const { handler: c } = e;
  ...
  const s = `message_${nn++}`, c = t.onClose, i = document.createElement("div"), _ = {
    ...t,
    id: s,
    onClose: () => {
      c?.(), _n(v);
  ...
  }, p = I(on, _, a2(_.message) || X2(_.message) ? {
    default: a2(_.message) ? _.message : () => _.message
  } : null);
  p.appContext = a || P._context, B2(p, i), e.appendChild(i.firstElementChild);
  const h = p.component, v = {
    id: s,
    vnode: p,
    vm: h,
    handler: {
  ...
  const a = H0(e), s = Xo(a.placement || E);
  if (a.grouping && s.length) {
    const i = s.find(({ vnode: _ }) => {
      var p;
      return ((p = _.props) == null ? void 0 : p.message) === a.message;
    });
    if (i)
      return i.props.repeatNum += 1, i.props.type = a.type, i.handler;
  }
  if (O(H.max) && s.length >= H.max)
    return { close: () => {
    } };
  const c = pn(a, t);
  return s.push(c), c.handler;
};
M0.forEach((e) => {
  P[e] = (t = {}, a) => {
    const s = H0(t);
...
function mn(e) {
  if (!L[e])
    return;
  [...L[e]].forEach((a) => a.handler.close());
}
P.closeAll = un;
P.closeAllByPlacement = mn;
P._context = null;
const hn = Po(P, "$message"), vn = (e) => {
  navigator.clipboard.writeText(e), hn.success("复制成功");
}, dn = { class: "" }, wn = { class: "container" }, fn = ["onDblclick"], gn = /* @__PURE__ */ o({
  __name: "index",
  props: {
    title: {
      type: String,
  ...
  setup(e, { emit: t }) {
    const a = t, s = e, c = d({
      ...
      vn(`el-icon-${G(h)}`), console.log(`<el-icon-${G(h)}></el-icon-${G(h)}>`), a("update:visible", !1);
    };
    return (h, x) => {
      const v = s2("el-button"), g = s2("el-scrollbar"), B = s2("el-dialog");
      return l(), n("div", dn, [
        I(v, {
          type: "primary",
          onClick: i
        ...
        I(B, {
          modelValue: c.value,
          "onUpdate:modelValue": x[0] || (x[0] = (C) => c.value = C),
          title: s.title,
          onClose: _
        }, {
          default: S(() => [
              ...
              default: S(() => [
                r("div", wn, [
                  (l(!0), n(
                    Y2,
                    null,
                    N0(Object.keys(b9), (C) => (l(), n("div", {
                      class: "icon-box",
                      onDblclick: () => p(C),
                      key: C
                    }, [
                      (l(), q(J2(`el-icon-${u(G)(C)}`), { class: "icon" })),
                      r(
                        "div",
                        null,
                        e2(C),
  ...
  for (const [s, c] of t)
    a[s] = c;
  return a;
}, Cn = /* @__PURE__ */ xn(gn, [["__scopeId", "data-v-cc6d71cb"]]), zn = {
  install(e) {
    e.component("ti-choose-icon", Cn);
  }
};
export {
  zn as default
