import { defineComponent as Xi, ref as Ji, onMounted as Ki, watch as es, createElementBlock as ts, openBlock as ns, createElementVNode as rs } from "vue";
var st, A, vr, br, me, te, mn, yr, Er, Ge = {}, Ar = [], is = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i;
function G(t, e) {
...
function p(t, e, n) {
  ...
  if (arguments.length > 2 && (l.children = arguments.length > 3 ? st.call(arguments, 2) : n), typeof t == "function" && t.defaultProps != null) for (s in t.defaultProps) l[s] === void 0 && (l[s] = t.defaultProps[s]);
  return je(t, l, r, i, null);
}
function je(t, e, n, r, i) {
  var s = { type: t, props: e, key: n, ref: r, __k: null, __: null, __b: 0, __e: null, __d: void 0, __c: null, __h: null, constructor: void 0, __v: i ?? ++vr };
...
function ss(t, e, n, r, i) {
  ...
  for (s in e) i && typeof e[s] != "function" || s === "children" || s === "key" || s === "value" || s === "checked" || n[s] === e[s] || Qe(t, s, e[s], n[s], r);
}
function vn(t, e, n) {
...
function Qe(t, e, n, r, i) {
  ...
  else if (e[0] === "o" && e[1] === "n") s = e !== (e = e.replace(/Capture$/, "")), e = e.toLowerCase() in t ? e.toLowerCase().slice(2) : e.slice(2), t.l || (t.l = {}), t.l[e + s] = n, n ? r || t.addEventListener(e, s ? yn : bn, s) : t.removeEventListener(e, s ? yn : bn, s);
...
function _e(t, e) {
  if (e == null) return t.__ ? _e(t.__, t.__.__k.indexOf(t) + 1) : null;
...
function xt(t) {
  (!t.__d && (t.__d = !0) && te.push(t) && !Ye.__r++ || mn !== A.debounceRendering) && ((mn = A.debounceRendering) || ls)(Ye);
}
function Ye() {
  var t, e, n, r, i, s, l, o;
  for (te.sort(function(a, d) {
    return a.__v.__b - d.__v.__b;
  }); t = te.shift(); ) t.__d && (e = te.length, r = void 0, i = void 0, l = (s = (n = t).__v).__e, (o = n.__P) && (r = [], (i = G({}, s)).__v = s.__v + 1, Wt(o, s, i, n.__n, o.ownerSVGElement !== void 0, s.__h != null ? [l] : null, r, l ?? _e(s), s.__h), Tr(r, s), s.__e != l && Dr(s)), te.length > e && te.sort(function(a, d) {
    return a.__v.__b - d.__v.__b;
  }));
  Ye.__r = 0;
}
function Cr(t, e, n, r, i, s, l, o, a, d) {
  ...
  for (n.__k = [], c = 0; c < e.length; c++) if ((u = n.__k[c] = (u = e[c]) == null || typeof u == "boolean" ? null : typeof u == "string" || typeof u == "number" || typeof u == "bigint" ? je(null, u, null, null, u) : Array.isArray(u) ? je(I, { children: u }, null, null, null) : u.__b > 0 ? je(u.type, u.props, u.key, u.ref ? u.ref : null, u.__v) : u) != null) {
    ...
    Wt(t, u, f = f || Ge, i, s, l, o, a, d), m = u.__e, (h = u.ref) && f.ref != h && (v || (v = []), f.ref && v.push(f.ref, null, u), v.push(h, u.__c || m, u)), m != null ? (b == null && (b = m), typeof u.type == "function" && u.__k === f.__k ? u.__d = a = wr(u, a, t) : a = _r(t, u, f, y, m, a), typeof n.type == "function" && (n.__d = a)) : a && f.__e == a && a.parentNode != t && (a = _e(f));
  }
  for (n.__e = b, c = E; c--; ) y[c] != null && (typeof n.type == "function" && y[c].__e != null && y[c].__e == n.__d && (n.__d = Rr(r).nextSibling), Ir(y[c], y[c]));
  if (v) for (c = 0; c < v.length; c++) Mr(v[c], v[++c], v[++c]);
}
function wr(t, e, n) {
  for (var r, i = t.__k, s = 0; i && s < i.length; s++) (r = i[s]) && (r.__ = t, e = typeof r.type == "function" ? wr(r, e, n) : _r(n, r, r, i, r.__e, e));
  return e;
}
function qe(t, e) {
...
function Rr(t) {
  ...
  if (t.__k) {
    for (e = t.__k.length - 1; e >= 0; e--) if ((n = t.__k[e]) && (r = Rr(n))) return r;
  }
  return null;
}
function Wt(t, e, n, r, i, s, l, o, a) {
  var d, c, h, f, u, m, b, v, y, E, S, D, H, x, k, C = e.type;
  if (e.constructor !== void 0) return null;
  n.__h != null && (a = n.__h, o = e.__e = n.__e, e.__h = null, s = [o]), (d = A.__b) && d(e);
  try {
    e: if (typeof C == "function") {
      if (v = e.props, y = (d = C.contextType) && r[d.__c], E = d ? y ? y.props.value : d.__ : r, n.__c ? b = (c = e.__c = n.__c).__ = c.__E : ("prototype" in C && C.prototype.render ? e.__c = c = new C(v, E) : (e.__c = c = new L(v, E), c.constructor = C, c.render = as), y && y.sub(c), c.props = v, c.state || (c.state = {}), c.context = E, c.__n = r, h = c.__d = !0, c.__h = [], c._sb = []), c.__s == null && (c.__s = c.state), C.getDerivedStateFromProps != null && (c.__s == c.state && (c.__s = G({}, c.__s)), G(c.__s, C.getDerivedStateFromProps(v, c.__s))), f = c.props, u = c.state, c.__v = e, h) C.getDerivedStateFromProps == null && c.componentWillMount != null && c.componentWillMount(), c.componentDidMount != null && c.__h.push(c.componentDidMount);
      else {
      ...
      if (c.context = E, c.props = v, c.__P = t, D = A.__r, H = 0, "prototype" in C && C.prototype.render) {
      ...
      while (c.__d && ++H < 25);
      c.state = c.__s, c.getChildContext != null && (r = G(G({}, r), c.getChildContext())), h || c.getSnapshotBeforeUpdate == null || (m = c.getSnapshotBeforeUpdate(f, u)), k = d != null && d.type === I && d.key == null ? d.props.children : d, Cr(t, Array.isArray(k) ? k : [k], e, n, r, i, s, l, o, a), c.base = e.__e, e.__h = null, c.__h.length && l.push(c), b && (c.__E = c.__ = null), c.__e = !1;
    } else s == null && e.__v === n.__v ? (e.__k = n.__k, e.__e = n.__e) : e.__e = os(n.__e, e, n, r, i, s, l, a);
    (d = A.diffed) && d(e);
  } catch (ue) {
...
function os(t, e, n, r, i, s, l, o) {
  ...
  if (u === null) h === f || o && t.data === f || (t.data = f);
    ...
    if (s = s && st.call(t.childNodes), d = (h = n.props || Ge).dangerouslySetInnerHTML, c = f.dangerouslySetInnerHTML, !o) {
    ...
    if (ss(t, f, h, i, o), c) e.__k = [];
    else if (m = e.props.children, Cr(t, Array.isArray(m) ? m : [m], e, n, r, i && u !== "foreignObject", s, l, s ? s[0] : n.__k && _e(n, 0), o), s != null) for (m = s.length; m--; ) s[m] != null && Sr(s[m]);
    o || ("value" in f && (m = f.value) !== void 0 && (m !== t.value || u === "progress" && !m || u === "option" && m !== h.value) && Qe(t, "value", m, h.value, !1), "checked" in f && (m = f.checked) !== void 0 && m !== t.checked && Qe(t, "checked", m, h.checked, !1));
  }
  return t;
}
function Mr(t, e, n) {
...
function Ir(t, e, n) {
  var r, i;
  if (A.unmount && A.unmount(t), (r = t.ref) && (r.current && r.current !== t.__e || Mr(r, null, e)), (r = t.__c) != null) {
  ...
  if (r = t.__k) for (i = 0; i < r.length; i++) r[i] && Ir(r[i], e, n || typeof t.type != "function");
...
function Re(t, e, n) {
  var r, i, s;
  A.__ && A.__(t, e), i = (r = !1) ? null : e.__k, s = [], Wt(e, t = e.__k = p(I, null, [t]), i || Ge, Ge, e.ownerSVGElement !== void 0, i ? null : e.firstChild ? st.call(e.childNodes) : null, s, i ? i.__e : e.firstChild, r), Tr(s, t);
}
function cs(t, e) {
...
}, me = !1, L.prototype.setState = function(t, e) {
  var n;
  n = this.__s != null && this.__s !== this.state ? this.__s : this.__s = G({}, this.state), typeof t == "function" && (t = t(G({}, n), this.props)), t && G(n, t), t != null && this.__v && (e && this._sb.push(e), xt(this));
}, L.prototype.forceUpdate = function(t) {
  this.__v && (this.__e = !0, t && this.__h.push(t), xt(this));
}, L.prototype.render = I, te = [], yr = typeof Promise == "function" ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout, Ye.__r = 0, Er = 0;
var F, pt, En, kr = [], mt = [], An = A.__b, Sn = A.__r, Dn = A.diffed, Cn = A.__c, wn = A.unmount;
function ds() {
  for (var t; t = kr.shift(); ) if (t.__P && t.__H) try {
    t.__H.__h.forEach(Fe), t.__H.__h.forEach(Ot), t.__H.__h = [];
  } catch (e) {
...
A.__b = function(t) {
  ...
  Sn && Sn(t);
  var e = (F = t.__c).__H;
  e && (pt === F ? (e.__h = [], F.__h = [], e.__.forEach(function(n) {
    n.__N && (n.__ = n.__N), n.__V = mt, n.__N = n.i = void 0;
  })) : (e.__h.forEach(Fe), e.__h.forEach(Ot), e.__h = [])), pt = F;
}, A.diffed = function(t) {
  Dn && Dn(t);
  var e = t.__c;
  e && e.__H && (e.__H.__h.length && (kr.push(e) !== 1 && En === A.requestAnimationFrame || ((En = A.requestAnimationFrame) || us)(ds)), e.__H.__.forEach(function(n) {
    n.i && (n.__H = n.i), n.__V !== mt && (n.__ = n.__V), n.i = void 0, n.__V = mt;
  })), pt = F = null;
}, A.__c = function(t, e) {
  e.some(function(n) {
    try {
...
(Tn.prototype = new L()).isPureReactComponent = !0, Tn.prototype.shouldComponentUpdate = function(t, e) {
  return Rn(this.props, t) || Rn(this.state, e);
};
var Mn = A.__b;
A.__b = function(t) {
...
function xr(t, e, n) {
  ...
  }), t.__c.__H = null), (t = fs({}, t)).__c != null && (t.__c.__P === n && (t.__c.__P = e), t.__c = null), t.__k = t.__k && t.__k.map(function(r) {
    return xr(r, e, n);
  })), t;
}
function Or(t, e, n) {
...
A.unmount = function(t) {
...
}, (vt.prototype = new L()).__c = function(t, e) {
  var n = e.__c, r = this;
  ...
  var i = e.__a && p(I, null, t.fallback);
  return i && (i.__h = null), [p(I, null, e.__a ? null : t.children), i];
};
...
function ps(t) {
  ...
  } }), Re(p(gs, { context: e.context }, t.__v), e.l)) : e.l && e.componentWillUnmount();
}
function ms(t, e) {
  var n = p(ps, { __v: t, i: e });
...
var vs = typeof Symbol < "u" && Symbol.for && Symbol.for("react.element") || 60103, bs = /^(?:accent|alignment|arabic|baseline|cap|clip(?!PathU)|color|dominant|fill|flood|font|glyph(?!R)|horiz|image|letter|lighting|marker(?!H|W|U)|overline|paint|pointer|shape|stop|strikethrough|stroke|text(?!L)|transform|underline|unicode|units|v|vector|vert|word|writing|x(?!C))[A-Z]/, ys = typeof document < "u", Es = function(t) {
...
A.event = function(t) {
  return xn && (t = xn(t)), t.persist = As, t.isPropagationStopped = Ss, t.isDefaultPrevented = Ds, t.nativeEvent = t;
};
var On = { configurable: !0, get: function() {
  return this.class;
} }, Nn = A.vnode;
A.vnode = function(t) {
  ...
  if (typeof e == "string") {
    ...
    for (var s in r = {}, n) {
      var l = n[s];
      ys && s === "children" && e === "noscript" || s === "value" && "defaultValue" in n && l == null || (s === "defaultValue" && "value" in n && n.value == null ? s = "value" : s === "download" && l === !0 ? l = "" : /ondoubleclick/i.test(s) ? s = "ondblclick" : /^onchange(textarea|input)/i.test(s + e) && !Es(n.type) ? s = "oninput" : /^onfocus$/i.test(s) ? s = "onfocusin" : /^onblur$/i.test(s) ? s = "onfocusout" : /^on(Ani|Tra|Tou|BeforeInp|Compo)/.test(s) ? s = s.toLowerCase() : i && bs.test(s) ? s = s.replace(/[A-Z0-9]/g, "-$&").toLowerCase() : l === null && (l = void 0), /^oninput$/i.test(s) && (s = s.toLowerCase(), r[s] && (s = "oninputCapture")), r[s] = l);
    }
    e == "select" && r.multiple && Array.isArray(r.value) && (r.value = qe(n.children).forEach(function(o) {
      o.props.selected = r.value.indexOf(o.props.value) != -1;
    })), e == "select" && r.defaultValue != null && (r.value = qe(n.children).forEach(function(o) {
      o.props.selected = r.multiple ? r.defaultValue.indexOf(o.props.value) != -1 : r.defaultValue == o.props.value;
    })), t.props = r, n.class != n.className && (On.enumerable = "className" in n, n.className != null && (r.class = n.className), Object.defineProperty(r, "className", On));
  }
  t.$$typeof = vs, Nn && Nn(t);
};
var Hn = A.__r;
...
const Hr = [], Nt = /* @__PURE__ */ new Map();
function Pr(t) {
  Hr.push(t), Nt.forEach((e) => {
    Lr(e, t);
  });
}
function Cs(t) {
  t.isConnected && // sometimes true if SSR system simulates DOM
  t.getRootNode && Br(t.getRootNode());
}
function Br(t) {
  let e = Nt.get(t);
  if (!e || !e.isConnected) {
...
const ks = /(top|left|right|bottom|width|height)$/i;
function Ae(t, e) {
  for (let n in e)
    Ur(t, n, e[n]);
}
function Ur(t, e, n) {
  n == null ? t.style[e] = "" : typeof n == "number" && ks.test(e) ? t.style[e] = `${n}px` : t.style[e] = n;
}
function jr(t) {
  var e, n;
...
function Hs(t) {
  t.style.userSelect = "none", t.style.webkitUserSelect = "none", t.addEventListener("selectstart", ot);
}
function Ps(t) {
  t.style.userSelect = "", t.style.webkitUserSelect = "", t.removeEventListener("selectstart", ot);
}
function Bs(t) {
...
function Fs(t, e, n) {
  return n.func ? n.func(t, e) : Vs(t[n.field], e[n.field]) * (n.order || 1);
}
function Vs(t, e) {
...
const Gs = /^(-?)(?:(\d+)\.)?(\d+):(\d\d)(?::(\d\d)(?:\.(\d\d\d))?)?/;
function _(t, e) {
  return typeof t == "string" ? Qs(t) : typeof t == "object" && t ? Un(t) : typeof t == "number" ? Un({ [e || "milliseconds"]: t }) : null;
}
function Qs(t) {
  let e = Gs.exec(t);
  if (e) {
...
const Xs = ["sun", "mon", "tue", "wed", "thu", "fri", "sat"];
function jn(t, e) {
  let n = Q(t);
  return n[2] += e * 7, B(n);
}
...
function At(t, e, n, r) {
  let i = B([e, 0, 1 + al(e, n, r)]), s = R(t), l = Math.round(ye(i, s));
...
function cl(t, e, n = !1) {
  let r = t.toISOString();
  return r = r.replace(".000", ""), n && (r = r.replace("T00:00:00Z", "")), r.length > 10 && (e == null ? r = r.replace("Z", "") : e !== 0 && (r = r.replace("Z", $t(e, !0)))), r;
}
function Zt(t) {
...
function $t(t, e = !1) {
  ...
  return e ? `${n + yt(i, 2)}:${yt(s, 2)}` : `GMT${n}${i}${s ? `:${yt(s, 2)}` : ""}`;
}
function w(t, e, n) {
  let r, i;
  return function(...s) {
...
function Ve(t, e, n) {
  let r, i;
  return (s) => (r ? j(r, s) || (i = t.call(this, s)) : i = t.call(this, s), r = s, i);
}
const St = {
  week: 3,
  separator: 9,
  ...
  minute: 1,
  second: 1
}, Ne = /\s*([ap])\.?m\.?/i, ul = /,/g, fl = /\s+/g, hl = /\u200e/g, gl = /UTC|GMT/;
class pl {
  constructor(e) {
    let n = {}, r = {}, i = 9;
    for (let s in e)
      s in St ? (r[s] = e[s], St[s] < 9 && (i = Math.min(St[s], i))) : (n[s] = e[s], s in $e && (i = Math.min($e[s], i)));
    this.standardDateProps = n, this.extendedSettings = r, this.smallestUnitNum = i, this.buildFormattingFunc = w(zn);
  }
  format(e, n) {
    return this.buildFormattingFunc(this.standardDateProps, this.extendedSettings, n)(e);
  }
  formatRange(e, n, r, i) {
    let { standardDateProps: s, extendedSettings: l } = this, o = Al(e.marker, n.marker, r.calendarSystem);
    if (!o)
    ...
    if (d === c)
      return d;
    let h = Sl(s, a), f = zn(h, l, r), u = f(e), m = f(n), b = Dl(d, u, c, m), v = l.separator || i || r.defaultSeparator || "";
...
function zn(t, e, n) {
  ...
  return r === 1 && t.timeZoneName === "short" ? (i) => $t(i.timeZoneOffset) : r === 0 && e.week ? (i) => El(n.computeWeekNumber(i.marker), n.weekText, n.weekTextLong, n.locale, e.week) : ml(t, e, n);
}
function ml(t, e, n) {
  t = Object.assign({}, t), e = Object.assign({}, e), vl(t, e), t.timeZone = "UTC";
...
function bl(t, e, n, r, i) {
  return t = t.replace(hl, ""), n.timeZoneName === "short" && (t = yl(t, i.timeZone === "UTC" || e.timeZoneOffset == null ? "UTC" : (
    // important to normalize for IE, which does "GMT"
    $t(e.timeZoneOffset)
  ))), r.omitCommas && (t = t.replace(ul, "").trim()), r.omitZeroMinute && (t = t.replace(":00", "")), r.meridiem === !1 ? t = t.replace(Ne, "").trim() : r.meridiem === "narrow" ? t = t.replace(Ne, (s, l) => l.toLocaleLowerCase()) : r.meridiem === "short" ? t = t.replace(Ne, (s, l) => `${l.toLocaleLowerCase()}m`) : r.meridiem === "lowercase" && (t = t.replace(Ne, (s) => s.toLocaleLowerCase())), t = t.replace(fl, " "), t = t.trim(), t;
}
function yl(t, e) {
  let n = !1;
  return t = t.replace(gl, () => (n = !0, e)), n || (t += ` ${e}`), t;
}
...
function Sl(t, e) {
  let n = {};
  for (let r in t)
    (!(r in $e) || // not a date part prop (like timeZone)
    $e[r] <= e) && (n[r] = t[r]);
  return n;
}
function Dl(t, e, n, r) {
...
function O(t) {
  return typeof t == "object" && t ? new pl(t) : typeof t == "string" ? new Cl(t) : typeof t == "function" ? new wl(t) : null;
}
const Gn = {
  navLinkDayClick: g,
  navLinkWeekClick: g,
...
function ee(t, e) {
  return typeof t == "object" && typeof e == "object" && t && e ? j(t, e) : t === e;
}
function He(t, e) {
...
function Ct(t, e, n = {}) {
  if (t === e)
    return !0;
  for (let r in e)
    if (!(r in t && Il(t[r], e[r], n[r]))) return !1;
  for (let r in t)
    if (!(r in e))
      return !1;
  return !0;
...
class Bl {
  ...
  createNowMarker() {
    return this.canComputeOffset ? this.timestampToMarker((/* @__PURE__ */ new Date()).valueOf()) : B(Fn(/* @__PURE__ */ new Date()));
  }
  createMarkerMeta(e) {
    if (typeof e == "string")
      return this.parse(e);
    let n = null;
    return typeof e == "number" ? n = this.timestampToMarker(e) : e instanceof Date ? (e = e.valueOf(), isNaN(e) || (n = this.timestampToMarker(e))) : Array.isArray(e) && (n = B(e)), n === null || !Wr(n) ? null : { marker: n, isTimeUnspecified: !1, forcedTzo: null };
  }
  parse(e) {
    let n = Pl(e);
    if (n === null)
  ...
  greatestWholeUnit(e, n) {
    ...
    return r !== null ? { unit: "year", value: r } : (r = this.diffWholeMonths(e, n), r !== null ? { unit: "month", value: r } : (r = rl(e, n), r !== null ? { unit: "week", value: r } : (r = Ze(e, n), r !== null ? { unit: "day", value: r } : (r = Ks(e, n), Et(r) ? { unit: "hour", value: r } : (r = el(e, n), Et(r) ? { unit: "minute", value: r } : (r = tl(e, n), Et(r) ? { unit: "second", value: r } : { unit: "millisecond", value: n.valueOf() - e.valueOf() }))))));
  }
  countDurationsBetween(e, n, r) {
    let i;
    return r.years && (i = this.diffWholeYears(e, n), i !== null) ? i / Zs(r) : r.months && (i = this.diffWholeMonths(e, n), i !== null) ? i / $s(r) : r.days && (i = Ze(e, n), i !== null) ? i / ge(r) : (n.valueOf() - e.valueOf()) / Te(r);
  }
  // Start-Of
  // these DON'T return zoned-dates. only UTC start-of dates
  startOf(e, n) {
    return n === "year" ? this.startOfYear(e) : n === "month" ? this.startOfMonth(e) : n === "week" ? this.startOfWeek(e) : n === "day" ? R(e) : n === "hour" ? il(e) : n === "minute" ? sl(e) : n === "second" ? ll(e) : null;
  }
  startOfYear(e) {
  ...
  // Week Number
  computeWeekNumber(e) {
    return this.weekNumberFunc ? this.weekNumberFunc(this.toDate(e)) : ol(e, this.weekDow, this.weekDoy);
  }
  ...
  */
  formatIso(e, n = {}) {
    let r = null;
    return n.omitTimeZoneOffset || (n.forcedTzo != null ? r = n.forcedTzo : r = this.offsetForMarker(e)), cl(e, r, n.omitTime);
  }
  // TimeZone
  timestampToMarker(e) {
    return this.timeZone === "local" ? B(Fn(new Date(e))) : this.timeZone === "UTC" || !this.namedTimeZoneImpl ? new Date(e) : B(this.namedTimeZoneImpl.timestampToArray(e));
  }
  offsetForMarker(e) {
    return this.timeZone === "local" ? -Vn(Q(e)).getTimezoneOffset() : this.timeZone === "UTC" ? 0 : this.namedTimeZoneImpl ? this.namedTimeZoneImpl.offsetForArray(Q(e)) : null;
  }
  // Conversion
  toDate(e, n) {
    return this.timeZone === "local" ? Vn(Q(e)) : this.timeZone === "UTC" ? new Date(e.valueOf()) : this.namedTimeZoneImpl ? new Date(e.valueOf() - this.namedTimeZoneImpl.offsetForArray(Q(e)) * 1e3 * 60) : new Date(e.valueOf() - (n || 0));
  }
}
class Ie {
  constructor(e) {
...
function Ke(t) {
  ...
  for (A.debounceRendering = r, Re(p(Ll, {}), document.createElement("div")); n.length; )
    n.shift()();
...
const ae = Yr({});
function jl(t, e, n, r, i, s, l, o, a, d, c, h, f, u) {
  return {
    dateEnv: i,
    nowManager: s,
    options: n,
    ...
    createScrollResponder(m) {
      return new Ul(m, c, _(n.scrollTime), n.scrollTimeReset);
    },
...
class ce extends L {
  ...
  safeSetState(e) {
    Ct(this.state, Object.assign(Object.assign({}, this.state), e), this.stateEquality) || this.setState(e);
  }
}
ce.addPropsEquality = Fl;
ce.addStateEquality = Vl;
ce.contextType = ae;
...
class en extends M {
  constructor() {
    super(...arguments), this.id = le(), this.queuedDomNodes = [], this.currentDomNodes = [], this.handleEl = (e) => {
      ...
      (!n.customRenderingReplaces || !Pt(r, n)) && this.updateElRef(e);
    }, this.updateElRef = (e) => {
      this.props.elRef && V(this.props.elRef, e);
    };
  }
  render() {
    const { props: e, context: n } = this, { options: r } = n, { customGenerator: i, defaultGenerator: s, renderProps: l } = e, o = qr(e, [], this.handleEl);
    let a = !1, d, c = [], h;
    if (i != null) {
      ...
      if (f === !0)
        ...
        u && "html" in f ? o.dangerouslySetInnerHTML = { __html: f.html } : u && "domNodes" in f ? c = Array.prototype.slice.call(f.domNodes) : (u ? br(f) : typeof f != "function") ? d = f : h = f;
      }
    } else
      a = !Pt(e.generatorName, r);
  ...
  triggerCustomRendering(e) {
    ...
    if (s) {
      ...
      o && s(Object.assign(Object.assign({
        ...
        generatorMeta: o
      }, r), { elClasses: (r.elClasses || []).filter(zl) }));
    }
  }
...
class W extends L {
  constructor() {
    super(...arguments), this.InnerContent = Wl.bind(void 0, this), this.handleEl = (e) => {
      this.el = e, this.props.elRef && (V(this.props.elRef, e), e && this.didMountMisfire && this.componentDidMount());
    };
  }
  render() {
    const { props: e } = this, n = Gl(e.classNameGenerator, e.renderProps);
    if (e.children) {
      const r = qr(e, n, this.handleEl), i = e.children(this.InnerContent, e.renderProps, r);
      return e.elTag ? p(e.elTag, r, i) : i;
    } else
      return p(en, Object.assign(Object.assign({}, e), { elRef: this.handleEl, elTag: e.elTag || "div", elClasses: (e.elClasses || []).concat(n), renderId: this.context }));
  }
  componentDidMount() {
    var e, n;
...
function Wl(t, e) {
  const n = t.props;
  return p(en, Object.assign({ renderProps: n.renderProps, generatorName: n.generatorName, customGenerator: n.customGenerator, defaultGenerator: n.defaultGenerator, renderId: t.context }, e));
}
function Gl(t, e) {
...
function Zn(t, e) {
  let n = [], { start: r } = e, i, s;
  for (t.sort(Yl), i = 0; i < t.length; i += 1)
...
function Xr(t) {
  let e = Math.floor(ye(t.start, t.end)) || 1, n = R(t.start), r = N(n, e);
...
function Jr(t, e = _(0)) {
  ...
  return t.start && (n = R(t.start), r && r <= n && (r = N(n, 1))), { start: n, end: r };
}
function he(t, e, n, r) {
  return r === "year" ? _(n.diffWholeYears(t, e), "year") : r === "month" ? _(n.diffWholeMonths(t, e), "month") : nl(t, e);
}
class Kr {
  constructor(e) {
  ...
  build(e, n, r = !0) {
    ...
    return s = this.buildValidRange(), s = this.trimHiddenDays(s), r && (e = Zl(e, s)), l = this.buildCurrentRangeInfo(e, n), o = /^(year|month|week|day)$/.test(l.unit), a = this.buildRenderRange(this.trimHiddenDays(l.range), l.unit, o), a = this.trimHiddenDays(a), d = a, i.showNonCurrentDates || (d = ve(d, l.range)), d = this.adjustActiveRange(d), d = ve(d, s), c = tn(l.range, s), q(a, e) || (e = a.start), {
      currentDate: e,
  ...
  buildCurrentRangeInfo(e, n) {
    ...
    return r.duration ? (i = r.duration, s = r.durationUnit, l = this.buildRangeFromDuration(e, n, i, s)) : (o = this.props.dayCount) ? (s = "day", l = this.buildRangeFromDayCount(e, n, o)) : (l = this.buildCustomVisibleRange(e)) ? s = r.dateEnv.greatestWholeUnit(l.start, l.end).unit : (i = this.getFallbackDuration(), s = Ht(i).unit, l = this.buildRangeFromDuration(e, n, i, s)), { duration: i, unit: s, range: l };
  }
  getFallbackDuration() {
    return _({ day: 1 });
  }
  ...
  adjustActiveRange(e) {
    ...
    return r && (ge(i) < 0 && (l = R(l), l = n.add(l, i)), ge(s) > 1 && (o = R(o), o = N(o, -1), o = n.add(o, s))), { start: l, end: o };
  }
...
function se(t, e, n) {
  ...
  for (let a in l) {
    ...
    if (d.recurringDef) {
      ...
      let h = Xl(d, c, e, r, i.recurringTypes);
      for (let f of h) {
        let u = nn(a, {
          start: f,
          end: r.add(f, c)
...
const ze = {
  ...
  date: g,
  allDay: Boolean
}, Jl = Object.assign(Object.assign(Object.assign({}, ze), ei), { extendedProps: g });
function ti(t, e, n, r, i = rn(n), s, l) {
  let { refined: o, extra: a } = ni(t, n, i), d = eo(e, n), c = $l(o, d, n.dateEnv, n.pluginHooks.recurringTypes);
  if (c) {
    let f = Bt(o, a, e ? e.sourceId : "", c.allDay, !!c.duration, n, s);
  ...
  let h = Kl(o, d, n, r);
  if (h) {
    let f = Bt(o, a, e ? e.sourceId : "", h.allDay, h.hasEnd, n, s), u = nn(f.defId, h.range, h.forcedStartTzo, h.forcedEndTzo);
    return l && f.publicId && l[f.publicId] && (u.instanceId = l[f.publicId]), { def: f, instance: u };
  }
  return null;
}
function ni(t, e, n = rn(e)) {
  return Xt(t, n);
}
function rn(t) {
  return Object.assign(Object.assign(Object.assign({}, et), Jl), t.pluginHooks.eventRefiners);
}
...
function sn(t, e) {
  let n = t.instances[e];
  if (n) {
    let r = t.defs[n.defId], i = ct(t, (s) => to(r, s));
...
function ro(t, e) {
  return Array.isArray(t) ? Me(t, null, e, !0) : typeof t == "object" && t ? Me([t], null, e, !0) : t != null ? String(t) : null;
}
function $n(t) {
...
function ii(t) {
  return Object.assign(Object.assign(Object.assign({}, et), oo), t.pluginHooks.eventSourceRefiners);
}
function ao(t, e) {
...
function co(t, e, n, r, i) {
  switch (e.type) {
    case "RECEIVE_EVENTS":
      return uo(t, n[e.sourceId], e.fetchId, e.fetchRange, e.rawEvents, i);
...
function uo(t, e, n, r, i, s) {
  ...
  n === e.latestFetchId) {
    let l = Me(si(i, e, s), e, s);
    return r && (l = se(l, r, s)), ln(li(t, e.sourceId), l);
  }
  return t;
}
function fo(t, e, n, r, i) {
  const { defIdMap: s, instanceIdMap: l } = po(t);
  let o = Me(si(n, e, i), e, i, !1, s, l);
  return se(o, r, i);
}
function si(t, e, n) {
  let r = n.options.eventDataTransform, i = e ? e.eventDataTransform : null;
  return i && (t = Xn(t, i)), r && (t = Xn(t, r)), t;
}
function Xn(t, e) {
  let n;
  if (!e)
...
function yo(t, e) {
  return Me(Eo(t), null, e);
}
function Eo(t) {
  let e;
  return t === !0 ? e = [{}] : Array.isArray(t) ? e = t.filter((n) => n.daysOfWeek) : typeof t == "object" && t ? e = [t] : e = [], e = e.map((n) => Object.assign(Object.assign({}, bo), n)), e;
}
function oi(t, e, n) {
  n.emitter.trigger("select", Object.assign(Object.assign({}, on(t, n)), { jsEvent: e ? e.origEvent : null, view: n.viewApi || n.calendarApi.view }));
}
function Ao(t, e) {
...
function on(t, e) {
  ...
  return Object.assign(n, Po(t, e.dateEnv)), n;
}
function Kn(t, e, n) {
...
function an(t, e, n, r) {
  let i = nt(t.defs, e), s = U();
  for (let l in t.defs) {
    let o = t.defs[l];
    s.defs[l] = So(o, i[l], n, r);
  }
  for (let l in t.instances) {
    let o = t.instances[l], a = s.defs[o.defId];
    s.instances[l] = Do(o, a, i[o.defId], n, r);
  }
  return s;
}
function So(t, e, n, r) {
...
function Do(t, e, n, r, i) {
  ...
  return l && (a.range = Xr(a.range)), r.datesDelta && n.startEditable && (a.range = {
  ...
  setDates(e, n, r = {}) {
    ...
    if (l && !(n != null && (o = i.createMarker(n), !o)) && this._instance) {
      ...
      if (o) {
        ...
        Ys(d, c) ? this.mutate({ datesDelta: d, standardProps: s }) : this.mutate({ startDelta: d, endDelta: c, standardProps: s });
      } else
...
function er(t, e, n, r) {
  ...
  for (let c in t.instances) {
    let h = t.instances[c], f = t.defs[h.defId], u = d[f.defId], m = h.range, b = !f.allDay && r ? Jr(m, r) : m, v = ve(b, n);
...
function Co(t, e) {
  let n = t.map(wo);
  return n.sort((r, i) => js(r, i, e)), n.map((r) => r._seg);
}
function wo(t) {
...
function di(t, e, n, r, i, s, l) {
  ...
  let u = f.range.start, m = f.range.end, b = t.start || t.eventRange.range.start, v = t.end || t.eventRange.range.end, y = R(u).valueOf() === R(b).valueOf(), E = R($(m, -1)).valueOf() === R($(v, -1)).valueOf();
...
function Oo(t, e) {
  let { refined: n, extra: r } = Xt(t, ko), i = n.start ? e.createMarkerMeta(n.start) : null, s = n.end ? e.createMarkerMeta(n.end) : null, { allDay: l } = n;
...
function No(t, e) {
  return ql(t.range, e.range) && t.allDay === e.allDay && Ho(t, e);
}
function Ho(t, e) {
  for (let n in e)
...
function Po(t, e) {
  return Object.assign(Object.assign({}, hi(t.range, e, t.allDay)), { allDay: t.allDay });
}
function fi(t, e, n) {
  return Object.assign(Object.assign({}, hi(t, e, n)), { timeZone: e.timeZone });
}
function hi(t, e, n) {
  return {
...
class Fo extends M {
  ...
  render() {
    ...
    return gi() || l.push("fc-liquid-hack"), e.children(l, s, i, r);
  }
  componentDidMount() {
...
class ut extends L {
  ...
  computeTiming() {
    ...
    (e.unitValue || 1) === 1);
    let s, l;
    return i ? (s = n.dateEnv.startOf(r, e.unit), l = n.dateEnv.add(s, _(1, e.unit)).valueOf() - r.valueOf()) : (s = r, l = 1e3 * 60), l = Math.min(1e3 * 60 * 60 * 24, l), {
      state: { nowDate: s, todayRange: zo(s) },
      waitMs: l
    };
  }
...
class Wo {
  ...
  select(e, n) {
    ...
    let i = this.getCurrentData(), s = xo(r, i.dateEnv, _({ days: 1 }));
    s && (this.dispatch({ type: "SELECT_DATES", selection: s }), oi(s, null, i));
  }
  unselect(e) {
    let n = this.getCurrentData();
    n.dateSelection && (this.dispatch({ type: "UNSELECT_DATES" }), Ao(e, n));
  }
  // Public Events API
  // -----------------------------------------------------------------------------------------------------------------
  addEvent(e, n) {
    if (e instanceof T) {
      ...
      return this.getCurrentData().eventStore.defs[l.defId] || (this.dispatch({
        type: "ADD_EVENTS",
        eventStore: Lt({ def: l, instance: o })
...
const Zo = O({ year: "numeric", month: "long", day: "numeric" }), $o = O({ week: "long" });
function jt(t, e, n = "day", r = !0) {
  const { dateEnv: i, options: s, calendarApi: l } = t;
  let o = i.format(e, n === "week" ? $o : Zo);
  if (s.navLinks) {
    let a = i.toDate(e);
    const d = (c) => {
...
function ta(t, e = !1) {
  ...
  return Xo() && n.direction === "rtl" ? c.scrollbarLeft = a : c.scrollbarRight = a, e && (c.paddingLeft = parseInt(n.paddingLeft, 10) || 0, c.paddingRight = parseInt(n.paddingRight, 10) || 0, c.paddingTop = parseInt(n.paddingTop, 10) || 0, c.paddingBottom = parseInt(n.paddingBottom, 10) || 0), c;
}
function na(t, e = !1, n) {
  let r = un(t), i = ta(t, e), s = {
...
function ra(t) {
  let e = bi(t), n = t.getBoundingClientRect();
  for (let r of e) {
    let i = pi(n, r.getBoundingClientRect());
    if (i)
      n = i;
    else
      return null;
...
class rt {
  ...
  similarTo(e) {
    return Pe(this.tops || [], e.tops || []) && Pe(this.bottoms || [], e.bottoms || []) && Pe(this.lefts || [], e.lefts || []) && Pe(this.rights || [], e.rights || []);
  }
}
function Pe(t, e) {
  const n = t.length;
...
class la {
  ...
  handleInvalidInsertion(e, n, r) {
    if (this.allowReslicing && e.touchingEntry) {
      const i = Object.assign(Object.assign({}, n), { span: yi(n.span, e.touchingEntry.span) });
  ...
  */
  ...
  insertEntryAt(e, n) {
    ...
    n.lateral === -1 ? (Tt(i, n.level, n.levelCoord), Tt(r, n.level, [e])) : Tt(r[n.level], n.lateral, e), this.stackCnts[we(e)] = n.stackCnt;
  }
  /*
  ...
  findInsertion(e) {
    ...
    for (let m = 0; m < l; m += 1) {
      ...
      for (
        ...
        let D = b + this.getEntryThickness(y);
...
class ca extends M {
  render() {
    let { dateEnv: e, options: n, theme: r, viewApi: i } = this.context, { props: s } = this, { date: l, dateProfile: o } = s, a = mi(l, s.todayRange, null, o), d = [Ei].concat(dn(a, r)), c = e.format(l, s.dayHeaderFormat), h = !a.isDisabled && s.colCnt > 1 ? jt(this.context, l) : {}, f = e.toDate(l);
    e.namedTimeZoneImpl && (f = $(f, 36e5));
    let u = Object.assign(Object.assign(Object.assign({ date: f, view: i }, s.extraRenderProps), { text: c }), a);
    return p(W, { elTag: "th", elClasses: d, elAttrs: Object.assign({ role: "columnheader", colSpan: s.colSpan, "data-date": a.isDisabled ? void 0 : Zt(l) }, s.extraDataAttrs), renderProps: u, generatorName: "dayHeaderContent", customGenerator: n.dayHeaderContent, defaultGenerator: Ai, classNameGenerator: n.dayHeaderClassNames, didMount: n.dayHeaderDidMount, willUnmount: n.dayHeaderWillUnmount }, (m) => p("div", { className: "fc-scrollgrid-sync-inner" }, !a.isDisabled && p(m, { elTag: "a", elAttrs: h, elClasses: [
      "fc-col-header-cell-cushion",
      s.isSticky && "fc-sticky"
    ] })));
  }
}
const da = O({ weekday: "long" });
class ua extends M {
  render() {
    ...
    return p(W, { elTag: "th", elClasses: [
      ...
      ...dn(o, r),
      ...e.extraClassNames || []
    ], elAttrs: Object.assign({ role: "columnheader", colSpan: e.colSpan }, e.extraDataAttrs), renderProps: d, generatorName: "dayHeaderContent", customGenerator: s.dayHeaderContent, defaultGenerator: Ai, classNameGenerator: s.dayHeaderClassNames, didMount: s.dayHeaderDidMount, willUnmount: s.dayHeaderWillUnmount }, (c) => p(
      "div",
...
class fa extends M {
  constructor() {
    super(...arguments), this.createDayHeaderFormatter = w(ha);
  }
  render() {
    ...
    return p(ut, { unit: "day" }, (o, a) => p(
      "tr",
      { role: "row" },
      s && s("day"),
      n.map((d) => i ? p(ca, { key: d.toISOString(), date: d, dateProfile: r, todayRange: a, colCnt: n.length, dayHeaderFormat: l }) : p(ua, { key: d.getUTCDay(), dow: d.getUTCDay(), dayHeaderFormat: l }))
    ));
  }
}
function ha(t, e, n) {
...
class ma {
  ...
  _sliceBusinessHours(e, n, r, i, ...s) {
    return e ? this._sliceEventStore(se(e, Be(n, !!r), i), {}, n, r, ...s).bg : [];
  }
  _sliceEventStore(e, n, r, i, ...s) {
    if (e) {
      let l = er(e, n, Be(r, !!i), i);
      return {
  ...
  _sliceInteraction(e, n, r, i, ...s) {
    if (!e)
      return null;
    let l = er(e.mutatedEvents, n, Be(r, !!i), i);
    return {
  ...
  _sliceDateSpan(e, n, r, i, s, ...l) {
    if (!e)
      return [];
    let o = Be(n, !!r), a = ve(e.range, o);
    if (a) {
      e = Object.assign(Object.assign({}, e), { range: a });
      let d = Bo(e, i, s), c = this.sliceRange(e.range, ...l);
      for (let h of c)
        h.eventRange = d;
      return c;
    }
...
function Si(t, e, n) {
  ...
  for (let i in r)
    if (!at(e.validRange, r[i].range))
      return !1;
  return Di({ eventDrag: t }, n);
}
function va(t, e, n) {
  return at(e.validRange, t.range) ? Di({ dateSelection: t }, n) : !1;
}
function Di(t, e) {
  ...
  return (e.pluginHooks.isPropsValid || ba)(r, e);
}
function ba(t, e, n = {}, r) {
  return !(t.eventDrag && !ya(t, e, n, r) || t.dateSelection && !Ea(t, e, n, r));
}
function ya(t, e, n, r) {
  ...
  r && (d = oe(d, r));
  let c = go(t.eventStore, s.affectedEvents.instances), h = c.defs, f = c.instances, u = nt(h, t.eventUiBases);
  for (let m in a) {
    let b = a[m], v = b.range, y = d[b.defId], E = o[b.defId];
    if (!Ci(y.constraints, v, c, t.businessHours, e))
      return !1;
    let { eventOverlap: S } = e.options, D = typeof S == "function" ? S : null;
    for (let x in f) {
      let k = f[x];
      if (tn(v, k.range) && (u[k.defId].overlap === !1 && s.isEvent || y.overlap === !1 || D && !D(
        new T(e, h[k.defId], k),
        // still event
        new T(e, E, b)
      )))
    ...
    for (let x of y.allows) {
      let k = Object.assign(Object.assign({}, n), { range: b.range, allDay: E.allDay }), C = H.defs[E.defId], ue = H.instances[m], gt;
      if (C ? gt = new T(e, C, ue) : gt = new T(e, E), !x(on(k, e), gt))
        return !1;
    }
  }
  return !0;
...
function Ea(t, e, n, r) {
  ...
  if (r && (d = r(d)), !Ci(d.constraints, a, i, t.businessHours, e))
    return !1;
...
function Ci(t, e, n, r, i) {
  for (let s of t)
    if (!Sa(Aa(s, e, n, r, i), e))
      return !1;
  return !0;
}
function Aa(t, e, n, r, i) {
  return t === "businessHours" ? Mt(se(r, e, i)) : typeof t == "string" ? Mt(ct(n, (s) => s.groupId === t)) : typeof t == "object" && t ? Mt(se(t, e, i)) : [];
}
function Mt(t) {
  let { instances: e } = t, n = [];
  for (let r in e)
...
class Da extends M {
  ...
  needsXScrolling() {
    if (Le.test(this.props.overflowX))
      return !1;
  ...
  needsYScrolling() {
    if (Le.test(this.props.overflowY))
      return !1;
...
class ne {
  ...
  collect(e, n, r) {
    return kl(this.currentMap, e, n, r);
  }
  getAll() {
    return Kt(this.currentMap);
  }
}
function Ca(t) {
  let e = Is(t, ".fc-scrollgrid-shrink"), n = 0;
  for (let r of e)
    n = Math.max(n, Ws(r));
  return Math.ceil(n);
}
...
function Ta(t, e) {
  ...
  for (let r of t) {
    ...
    for (let s = 0; s < i; s += 1)
      n.push(p("col", { style: {
        width: r.width === "shrink" ? Ma(e) : r.width || "",
        minWidth: r.minWidth || ""
      } }));
  }
  return p("colgroup", {}, ...n);
...
class _i extends M {
  constructor() {
    super(...arguments), this.processCols = w((e) => e, Ra), this.renderMicroColGroup = w(Ta), this.scrollerRefs = new ne(), this.scrollerElRefs = new ne(this._handleScrollerEl.bind(this)), this.state = {
      shrinkWidth: null,
      forceYScrollbars: !1,
  ...
  render() {
    let { props: e, state: n, context: r } = this, i = e.sections || [], s = this.processCols(e.cols), l = this.renderMicroColGroup(s, n.shrinkWidth), o = ka(e.liquid, r);
  ...
  renderSection(e, n, r) {
    return "outerContent" in e ? p(I, { key: e.key }, e.outerContent) : p("tr", { key: e.key, role: "presentation", className: xa(e, this.props.liquid).join(" ") }, this.renderChunkTd(e, n, e.chunk, r));
  }
  renderChunkTd(e, n, r, i) {
    if ("outerContent" in r)
      return r.outerContent;
    let { props: s } = this, { forceYScrollbars: l, scrollerClientWidths: o, scrollerClientHeights: a } = this.state, d = wa(s, e), c = wi(s, e), h = s.liquid ? l ? "scroll" : d ? "auto" : "hidden" : "visible", f = e.key, u = _a(e, r, {
      tableColGroupNode: n,
      tableMinWidth: "",
    ...
    return p(i ? "th" : "td", {
      ...
      p(Da, { ref: this.scrollerRefs.createRef(f), elRef: this.scrollerElRefs.createRef(f), overflowY: h, overflowX: s.liquid ? "hidden" : "visible", maxHeight: e.maxHeight, liquid: c, liquidIsAbsolute: !0 }, u)
    ));
  }
  _handleScrollerEl(e, n) {
    let r = Ha(this.props.sections, n);
  ...
  computeShrinkWidth() {
    return Ia(this.props.cols) ? Ca(this.scrollerElRefs.getAll()) : 0;
  }
  computeScrollerDims() {
    let e = Ko(), { scrollerRefs: n, scrollerElRefs: r } = this, i = !1, s = {}, l = {};
...
_i.addStateEquality({
  scrollerClientWidths: j,
  scrollerClientHeights: j
});
function Ha(t, e) {
  for (let n of t)
    if (n.key === e)
...
class gn extends M {
  constructor() {
    super(...arguments), this.buildPublicEvent = w((e, n, r) => new T(e, n, r)), this.handleEl = (e) => {
      this.el = e, V(this.props.elRef, e), e && tr(e, this.props.seg);
    };
  }
  render() {
    const { props: e, context: n } = this, { options: r } = n, { seg: i } = e, { eventRange: s } = i, { ui: l } = s, o = {
      ...
      isDraggable: !e.disableDragging && _o(i, n),
      isStartResizable: !e.disableResizing && Ro(i, n),
      isEndResizable: !e.disableResizing && To(i),
...
class Ri extends M {
  render() {
    let { props: e, context: n } = this, { options: r } = n, { seg: i } = e, { ui: s } = i.eventRange, l = r.eventTimeFormat || e.defaultTimeFormat, o = di(i, l, n, e.defaultDisplayEventTime, e.defaultDisplayEventEnd);
    return p(gn, Object.assign({}, e, { elTag: "a", elStyle: {
      borderColor: s.borderColor,
      backgroundColor: s.backgroundColor
    }, elAttrs: ui(i, n), defaultGenerator: Pa, timeText: o }), (a, d) => p(
      I,
      null,
...
const Ba = O({ day: "numeric" });
class Ti extends M {
  constructor() {
    super(...arguments), this.refineRenderProps = Ve(La);
  }
  render() {
    ...
    return p(W, { elRef: e.elRef, elTag: e.elTag, elAttrs: Object.assign(Object.assign({}, e.elAttrs), i.isDisabled ? {} : { "data-date": Zt(e.date) }), elClasses: [
      ...dn(i, n.theme),
      ...e.elClasses || []
...
function Mi(t) {
  return !!(t.dayCellContent || Pt("dayCellContent", t));
}
function La(t) {
  let { date: e, dateEnv: n, dateProfile: r, isMonthStart: i } = t, s = mi(e, t.todayRange, null, r), l = t.showDayNumber ? n.format(e, i ? t.monthStartFormat : Ba) : "";
...
class Ua extends M {
  render() {
    ...
    return p(gn, { elTag: "div", elClasses: ["fc-bg-event"], elStyle: { backgroundColor: n.eventRange.ui.backgroundColor }, defaultGenerator: ja, seg: n, timeText: "", isDragging: !1, isResizing: !1, isDateSelecting: !1, isSelected: !1, isPast: e.isPast, isFuture: e.isFuture, isToday: e.isToday, disableDragging: !0, disableResizing: !0 });
  }
}
function ja(t) {
  let { title: e } = t.event;
...
const Va = (t) => p(ae.Consumer, null, (e) => {
  ...
  return p(
    W,
    { elRef: t.elRef, elTag: t.elTag, elAttrs: t.elAttrs, elClasses: t.elClasses, elStyle: t.elStyle, renderProps: a, generatorName: "weekNumberContent", customGenerator: r.weekNumberContent, defaultGenerator: za, classNameGenerator: r.weekNumberClassNames, didMount: r.weekNumberDidMount, willUnmount: r.weekNumberWillUnmount },
    t.children
  );
});
function za(t) {
...
class Wa extends M {
  ...
  updateSize() {
    let { isRtl: e } = this.context, { alignmentEl: n, alignGridTop: r } = this.props, { rootEl: i } = this, s = ra(n);
    if (s) {
      let l = i.getBoundingClientRect(), o = r ? P(n, ".fc-scrollgrid").getBoundingClientRect().top : s.top, a = e ? s.right - l.width : s.left;
      o = Math.max(o, It), a = Math.min(a, document.documentElement.clientWidth - It - l.width), a = Math.max(a, It);
...
class Ga extends de {
  ...
  render() {
    ...
    return p(Ti, { elRef: this.handleRootEl, date: i, dateProfile: l, todayRange: s }, (a, d, c) => p(
      Wa,
      ...
      Mi(e) && p(a, { elTag: "div", elClasses: ["fc-more-popover-misc"] }),
      r.children
    ));
  }
  queryHit(e, n, r, i) {
...
class Qa extends M {
  constructor() {
    super(...arguments), this.state = {
      ...
      let { props: n, context: r } = this, { moreLinkClick: i } = r.options, s = lr(n).start;
      function l(o) {
  ...
  render() {
    ...
    return p(ae.Consumer, null, (r) => {
      let { viewApi: i, options: s, calendarApi: l } = r, { moreLinkText: o } = s, { moreCnt: a } = e, d = lr(e), c = typeof o == "function" ? o.call(l, a) : `+${a} ${o}`, h = Se(s.moreLinkHint, [a], c), f = {
        num: a,
        shortText: `+${a}`,
        text: c,
        view: i
...
function $a(t) {
  return t.reduce(Xa).eventRange.range.end;
}
function Xa(t, e) {
...
}, ki = Object.assign(Object.assign({}, Ii), {
...
function Ka(t) {
  let e = t.length > 0 ? t[0].code : "en", n = Ja.concat(t), r = {
    en: ki
  };
  for (let i of n)
    r[i.code] = i;
...
function xi(t, e) {
  return typeof t == "object" && !Array.isArray(t) ? Oi(t.code, [t.code], t) : ec(t, e);
}
function ec(t, e) {
  let n = [].concat(t || []), r = tc(n, e) || ki;
  return Oi(t, n, r);
}
function tc(t, e) {
...
function nc(t, e) {
  ...
  function i(s) {
    for (let l of s) {
      ...
      a === void 0 ? (n[o] = l.id, i(l.deps), r = ic(r, l)) : a !== l.id && console.warn(`Duplicate plugin '${o}'`);
    }
  }
  return t && i(t), i(e), r;
}
function rc() {
  let t = [], e = [], n;
  return (r, i) => ((!n || !Z(r, t) || !Z(i, e)) && (n = nc(r, i)), t = r, e = i, n);
}
function ic(t, e) {
  return {
    premiumReleaseDate: sc(t.premiumReleaseDate, e.premiumReleaseDate),
...
function ac(t) {
  ...
  return e.content ? n = ar(e) : n && !(n.prototype instanceof M) && (n = ar(Object.assign(Object.assign({}, e), { content: n }))), {
    superType: e.type,
    component: n,
    rawOptions: e
...
function ar(t) {
  return (e) => p(ae.Consumer, null, (n) => p(W, { elTag: "div", elClasses: $r(n.viewSpec), renderProps: Object.assign(Object.assign({}, e), { nextDayThreshold: n.options.nextDayThreshold }), generatorName: void 0, customGenerator: t.content, classNameGenerator: t.classNames, didMount: t.didMount, willUnmount: t.willUnmount }));
}
function cc(t, e, n, r) {
  let i = or(t), s = or(e.views), l = lc(i, s);
  return oe(l, (o) => dc(o, s, e, n, r));
}
...
function uc(t) {
  ...
  return n === void 0 && (n = _(t), cr[e] = n), n;
}
function fc(t, e) {
  switch (e.type) {
    case "CHANGE_VIEW_TYPE":
...
function bc(t, e, n, r) {
  ...
  switch (e.type) {
    ...
    case "RECEIVE_EVENT_ERROR":
      return Dc(t, e.sourceId, e.fetchId, e.fetchRange);
    case "REMOVE_ALL_EVENT_SOURCES":
      return {};
    default:
      return t;
...
function Pi(t, e, n) {
  return pn(t, ie(t, (r) => Ac(r, e, n)), e, !1, n);
}
function Ac(t, e, n) {
...
function Ic(t, e, n, r, i, s) {
  ...
  return { widgets: f.map((v) => v.split(",").map((y) => {
    ...
    if (E = o[y])
      ...
      }, (H = r.getCustomButtonIconClass(E)) || (H = r.getIconClass(y, l)) || (x = E.text), k = E.hint || E.text;
    else if (S = i[y]) {
      u.push(y), D = () => {
        s.changeView(y);
      }, (x = S.buttonTextOverride) || (H = r.getIconClass(y, l)) || (x = S.buttonTextDefault);
      ...
      if (D = () => {
        s[y]();
      }, (x = a[y]) || (H = r.getIconClass(y, l)) || (x = d[y]), y === "prevYear" || y === "nextYear") {
    ...
    return { buttonName: y, buttonClick: D, buttonIcon: H, buttonText: x, buttonHint: k };
...
let Nc = {
  ...
  fetch(t, e, n) {
    ...
    Lo(i.bind(null, fi(t.range, r)), (s) => e({ rawEvents: s }), n);
  }
};
const Hc = X({
...
let Bc = {
  ...
  fetch(t, e, n) {
    const { meta: r } = t.eventSource, i = Uc(r, t.range, t.context);
    Uo(r.method, r.url, i).then(([s, l]) => {
...
let Fc = {
  parse(t, e) {
    if (t.daysOfWeek || t.startTime || t.endTime || t.startRecur || t.endRecur) {
      ...
      return t.duration && (r = t.duration), !r && t.startTime && t.endTime && (r = qs(t.endTime, t.startTime)), {
  ...
  expand(t, e, n) {
    ...
    return r ? zc(t.daysOfWeek, t.startTime, t.dateEnv, n, r) : [];
  }
};
const Vc = X({
...
function zc(t, e, n, r, i) {
  let s = t ? Gr(t) : null, l = R(i.start), o = i.end, a = [];
...
function ur(t, e) {
  let n = Kt(e.getCurrentData().eventSources);
...
class qc {
  constructor(e, n) {
    this.runTaskOption = e, this.drainedOption = n, this.queue = [], this.delayedRunner = new Gt(this.drain.bind(this));
  }
  request(e, n) {
...
function Zc(t, e, n) {
  let r;
  return /^(year|month)$/.test(t.currentRangeUnit) ? r = t.currentRange : r = t.activeRange, n.formatRange(r.start, r.end, O(e.titleFormat || $c(t)), {
...
class Xc {
  constructor(e) {
    this.computeCurrentViewData = w(this._computeCurrentViewData), this.organizeRawLocales = w(Ka), this.buildLocale = w(xi), this.buildPluginHooks = rc(), this.buildDateEnv = w(Jc), this.buildTheme = w(Kc), this.parseToolbars = w(Mc), this.buildViewSpecs = w(cc), this.buildDateProfileGenerator = Ve(ed), this.buildViewApi = w(td), this.buildViewUiProps = Ve(id), this.buildEventUiBySource = w(nd, j), this.buildEventUiBases = w(rd), this.parseContextBusinessHours = Ve(sd), this.buildTitle = w(Zc), this.nowManager = new fr(), this.emitter = new dt(), this.actionRunner = new qc(this._handleAction.bind(this), this.updateData.bind(this)), this.currentCalendarOptionsInput = {}, this.currentCalendarOptionsRefined = {}, this.currentViewOptionsInput = {}, this.currentViewOptionsRefined = {}, this.currentCalendarOptionsRefiners = {}, this.optionsForRefining = [], this.optionsForHandling = [], this.getCurrentData = () => this.data, this.dispatch = (f) => {
      this.actionRunner.request(f);
    }, this.props = e, this.actionRunner.pause(), this.nowManager = new fr();
    ...
    }, o = gc(r.calendarOptions, r.dateEnv, this.nowManager), a = s.dateProfileGenerator.build(o);
    q(a.activeRange, o) || (o = a.currentRange.start);
    for (let f of r.pluginHooks.contextInit)
      f(l);
    let d = vc(r.calendarOptions, a, l), c = {
    ...
    kt(c, l) && this.emitter.trigger("loading", !0), this.state = c, this.updateData(), this.actionRunner.resume();
  }
  resetOptions(e, n) {
    let { props: r } = this;
  ...
  _handleAction(e) {
    let { props: n, state: r, emitter: i } = this, s = pc(r.dynamicOptionOverrides, e), l = this.computeOptionsData(n.optionOverrides, s, n.calendarApi), o = fc(r.currentViewType, e), a = this.computeCurrentViewData(o, l, n.optionOverrides, s);
    ...
    this.data && this.data.dateProfileGenerator !== a.dateProfileGenerator && (h = a.dateProfileGenerator.build(c)), c = hc(c, e), h = mc(h, e, c, a.dateProfileGenerator), (e.type === "PREV" || // TODO: move this logic into DateProfileGenerator
    e.type === "NEXT" || // "
    !q(h.currentRange, c)) && (c = h.currentRange.start);
    let f = bc(r.eventSources, e, h, d), u = co(r.eventStore, e, f, h, d), b = Ni(f) && !a.options.progressiveEventRendering && r.renderableEventStore || u, { eventUiSingleBase: v, selectionConfig: y } = this.buildViewUiProps(d), E = this.buildEventUiBySource(f), S = this.buildEventUiBases(b.defs, v, E), D = {
      ...
      dateSelection: wc(r.dateSelection, e),
      eventSelection: _c(r.eventSelection, e),
      eventDrag: Rc(r.eventDrag, e),
      eventResize: Tc(r.eventResize, e)
    }, H = Object.assign(Object.assign({}, d), D);
    for (let C of l.pluginHooks.reducers)
      Object.assign(D, C(r, e, H));
    let x = kt(r, d), k = kt(D, d);
    !x && k ? i.trigger("loading", !0) : x && !k && i.trigger("loading", !1), this.state = D, n.onAction && n.onAction(e);
  }
  updateData() {
    ...
    if (a && a !== d) {
      a.timeZone !== d.timeZone && (n.eventSources = l.eventSources = yc(l.eventSources, n.dateProfile, l), n.eventStore = l.eventStore = Jn(l.eventStore, r.dateEnv, l.dateEnv), n.renderableEventStore = l.renderableEventStore = Jn(l.renderableEventStore, r.dateEnv, l.dateEnv));
      for (let c in o)
  ...
  processRawCalendarOptions(e, n) {
    let { locales: r, locale: i } = Dt([
      ...
      e,
      n
    ]), s = this.organizeRawLocales(r), l = s.map, o = this.buildLocale(i || s.defaultCode, l).options, a = this.buildPluginHooks(e.plugins || [], Yc), d = this.currentCalendarOptionsRefiners = Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, Gn), Qn), Yn), a.listenerRefiners), a.optionRefiners), c = {}, h = Dt([
      De,
      o,
      e,
      n
  ...
  _computeCurrentViewData(e, n, r, i) {
    ...
    hr(o), this.nowManager.handleInput(n.dateEnv, l.now);
  ...
  processRawViewOptions(e, n, r, i, s) {
    let l = Dt([
      ...
      e.optionOverrides,
      s
    ]), o = Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, Gn), Qn), Yn), _l), n.listenerRefiners), n.optionRefiners), a = {}, d = this.currentViewOptionsInput, c = this.currentViewOptionsRefined, h = !1, f = {};
    for (let u in l)
...
function sd(t) {
  return yo(t.options.businessHours, t);
}
function hr(t, e) {
  for (let n in t)
  ...
  renderWidgetGroup(e) {
    ...
    for (let l of e) {
      ...
      if (o === "title")
        ...
        f && m.push(r.getClass("buttonActive")), i.push(p("button", { type: "button", title: typeof h == "function" ? h(n.navUnit) : h, disabled: u, "aria-pressed": f, className: m.join(" "), onClick: a }, d || (c ? p("span", { className: c, role: "img" }) : "")));
      }
    }
    if (i.length > 1) {
...
class gr extends M {
  ...
  renderSection(e, n) {
    let { props: r } = this;
    return p(ld, { key: e, widgetGroups: n, title: r.title, navUnit: r.navUnit, activeButton: r.activeButton, isTodayEnabled: r.isTodayEnabled, isPrevEnabled: r.isPrevEnabled, isNextEnabled: r.isNextEnabled, titleId: r.titleId });
  }
}
class od extends M {
  constructor() {
...
class dd extends ce {
  constructor() {
    super(...arguments), this.buildViewContext = w(jl), this.buildViewPropTransformers = w(fd), this.buildToolbarProps = w(ud), this.headerRef = z(), this.footerRef = z(), this.interactionsStore = {}, this.state = {
      viewLabelId: lt()
      ...
      this.interactionsStore[e.uid] = l, Ut[e.uid] = r;
    ...
    return p(
      ...
      p(ut, { unit: "day" }, (d) => {
        ...
        return p(
          I,
          null,
          n.header && p(gr, Object.assign({ ref: this.headerRef, extraClassName: "fc-header-toolbar", model: n.header, titleId: a }, c)),
          p(
            od,
          ...
          n.footer && p(gr, Object.assign({ ref: this.footerRef, extraClassName: "fc-footer-toolbar", model: n.footer, titleId: "" }, c))
        );
      })
    );
  }
  ...
  constructor(e, n = {}) {
    super(), this.isRendering = !1, this.isRendered = !1, this.currentClassNames = [], this.customContentRenderId = 0, this.handleAction = (r) => {
      ...
      if (this.isRendering) {
        ...
        Ke(() => {
          Re(p(Fo, { options: r.calendarOptions, theme: r.theme, emitter: r.emitter }, (i, s, l, o) => (this.setClassNames(i), this.setHeight(s), p(
            Zr.Provider,
            { value: this.customContentRenderId },
            p(dd, Object.assign({ isHeightAuto: l, forPrint: o }, r))
          ))), this.el);
        });
      } else this.isRendered && (this.isRendered = !1, Re(null, this.el), this.setClassNames([]), this.setHeight(""));
    }, Cs(e), this.el = e, this.renderRunner = new Gt(this.handleRenderRequest), new Xc({
      optionOverrides: n,
      calendarApi: this,
...
class gd extends de {
  ...
  renderSimpleLayout(e, n) {
    let { props: r, context: i } = this, s = [], l = sr(i.options);
    return e && s.push({
      type: "header",
      key: "header",
      isSticky: l,
      ...
      p(_i, { liquid: !r.isHeightAuto && !r.forPrint, collapsibleWidth: r.forPrint, cols: [], sections: s })
    );
  }
  renderHScrollLayout(e, n, r, i) {
    ...
    let { props: l, context: o } = this, a = !l.forPrint && sr(o.options), d = !l.forPrint && Na(o.options), c = [];
    return e && c.push({
      type: "header",
      key: "header",
      isSticky: a,
...
class Fi extends M {
  render() {
    let { props: e } = this;
    return p(Ri, Object.assign({}, e, { elClasses: ["fc-daygrid-event", "fc-daygrid-block-event", "fc-h-event"], defaultTimeFormat: Ui, defaultDisplayEventEnd: e.defaultDisplayEventEnd, disableResizing: !e.seg.eventRange.def.allDay }));
  }
}
class Vi extends M {
  render() {
    let { props: e, context: n } = this, { options: r } = n, { seg: i } = e, s = r.eventTimeFormat || Ui, l = di(i, s, n, !0, e.defaultDisplayEventEnd);
    return p(gn, Object.assign({}, e, { elTag: "a", elClasses: ["fc-daygrid-event", "fc-daygrid-dot-event"], elAttrs: ui(e.seg, n), defaultGenerator: pd, timeText: l, isResizing: !1, isDateSelecting: !1 }));
  }
}
function pd(t) {
  return p(
...
class md extends M {
  constructor() {
    super(...arguments), this.compileSegs = w(vd);
  }
  render() {
    let { props: e } = this, { allSegs: n, invisibleSegs: r } = this.compileSegs(e.singlePlacements);
    return p(Qa, { elClasses: ["fc-daygrid-more-link"], dateProfile: e.dateProfile, todayRange: e.todayRange, allDayDate: e.allDayDate, moreCnt: e.moreCnt, allSegs: n, hiddenSegs: r, alignmentElRef: e.alignmentElRef, alignGridTop: e.alignGridTop, extraDateSpan: e.extraDateSpan, popoverContent: () => {
      ...
      return p(I, null, n.map((s) => {
        ...
        } }, ji(s) ? p(Vi, Object.assign({ seg: s, isDragging: !1, isSelected: l === e.eventSelection, defaultDisplayEventEnd: !1 }, Ce(s, e.todayRange))) : p(Fi, Object.assign({ seg: s, isDragging: !1, isResizing: !1, isDateSelecting: !1, isSelected: l === e.eventSelection, defaultDisplayEventEnd: !1 }, Ce(s, e.todayRange))));
      }));
    } });
  }
}
...
class yd extends de {
  ...
  render() {
    ...
    const d = n.showDayNumber && Ad(o, a.currentRange, l);
    return p(Ti, { elTag: "td", elRef: this.handleRootEl, elClasses: [
      "fc-daygrid-day",
      ...n.extraClassNames || []
    ], elAttrs: Object.assign(Object.assign(Object.assign({}, n.extraDataAttrs), n.showDayNumber ? { "aria-labelledby": r.dayNumberId } : {}), { role: "gridcell" }), defaultGenerator: Ed, date: o, dateProfile: a, todayRange: n.todayRange, showDayNumber: n.showDayNumber, isMonthStart: d, extraRenderProps: n.extraRenderProps }, (c, h) => p(
      "div",
      { ref: n.innerElRef, className: "fc-daygrid-day-frame fc-scrollgrid-sync-inner", style: { minHeight: n.minHeight } },
      n.showWeekNumber && p(Va, { elTag: "a", elClasses: ["fc-daygrid-week-number"], elAttrs: jt(e, o, "week"), date: o, defaultFormat: bd }),
      !h.isDisabled && (n.showDayNumber || Mi(s) || n.forceDayTop) ? p(
        "div",
      ...
      p(
        ...
        p(
          ...
          p(md, { allDayDate: o, singlePlacements: n.singlePlacements, moreCnt: n.moreCnt, alignmentElRef: i, alignGridTop: !n.showDayNumber, extraDateSpan: n.extraDateSpan, dateProfile: n.dateProfile, eventSelection: n.eventSelection, eventDrag: n.eventDrag, eventResize: n.eventResize, todayRange: n.todayRange })
        )
      ),
...
function Wi(t) {
  return zi(t) + ":" + t.lastCol;
}
function Sd(t, e, n, r, i, s, l) {
  let o = new wd((y) => {
  ...
  let c = o.addSegs(a), h = o.toRects(), { singleColPlacements: f, multiColPlacements: u, leftoverMargins: m } = Dd(h, t, l), b = [], v = [];
  for (let y of d) {
    u[y.firstCol].push({
      seg: y,
      isVisible: !1,
    ...
    if (this.hiddenConsumes && l) {
      ...
      if (!s[d])
        if (this.allowReslicing) {
          const c = Object.assign(Object.assign({}, l), { span: yi(l.span, n.span) }), h = we(c);
...
class Gi extends de {
  constructor() {
    super(...arguments), this.cellElRefs = new ne(), this.frameElRefs = new ne(), this.fgElRefs = new ne(), this.segHarnessRefs = new ne(), this.rootElRef = z(), this.state = {
      framePositions: null,
  ...
  render() {
    let { props: e, state: n, context: r } = this, { options: i } = r, s = e.cells.length, l = Ue(e.businessHourSegs, s), o = Ue(e.bgEventSegs, s), a = Ue(this.getHighlightSegs(), s), d = Ue(this.getMirrorSegs(), s), { singleColPlacements: c, multiColPlacements: h, moreCnts: f, moreMarginTops: u } = Sd(Co(e.fgEventSegs, i.eventOrder), e.dayMaxEvents, e.dayMaxEventRows, i.eventOrderStrict, n.segHeights, n.maxContentHeight, e.cells), m = (
  ...
  renderFgSegs(e, n, r, i, s, l, o) {
    ...
    if (c)
      for (let m of n) {
        let { seg: b } = m, { instanceId: v } = b.eventRange.instance, y = m.isVisible && !i[v], E = m.isAbsolute, S = "", D = "";
        E && (a.isRtl ? (D = 0, S = c.lefts[b.lastCol] - c.lefts[b.firstCol]) : (S = 0, D = c.rights[b.firstCol] - c.rights[b.lastCol])), u.push(p("div", { className: "fc-daygrid-event-harness" + (E ? " fc-daygrid-event-harness-abs" : ""), key: zi(b), ref: f ? null : this.segHarnessRefs.createRef(Wi(b)), style: {
          visibility: y ? "" : "hidden",
          marginTop: E ? "" : m.marginTop,
          top: E ? m.absoluteTop : "",
          left: S,
          right: D
        } }, ji(b) ? p(Vi, Object.assign({ seg: b, isDragging: s, isSelected: v === d, defaultDisplayEventEnd: h }, Ce(b, r))) : p(Fi, Object.assign({ seg: b, isDragging: s, isResizing: l, isDateSelecting: o, isSelected: v === d, defaultDisplayEventEnd: h }, Ce(b, r)))));
      }
    return u;
  }
  renderFillSegs(e, n) {
    ...
    if (s)
      for (let o of e) {
        ...
        l.push(p("div", { key: Io(o.eventRange), className: "fc-daygrid-bg-harness", style: a }, n === "bg-event" ? p(Ua, Object.assign({ seg: o }, Ce(o, i))) : Fa(n)));
      }
    return p(I, {}, ...l);
  }
  updateSizing(e) {
...
class Td extends de {
  constructor() {
    super(...arguments), this.splitBusinessHourSegs = w(We), this.splitBgEventSegs = w(Md), this.splitFgEventSegs = w(We), this.splitDateSelectionSegs = w(We), this.splitEventDrag = w(pr), this.splitEventResize = w(pr), this.rowRefs = new ne();
  }
  render() {
    ...
    return p(ut, { unit: "day" }, (h, f) => p(I, null, e.cells.map((u, m) => p(Gi, {
...
class kd extends de {
    ...
    return p(
      ...
      p(
        ...
        p(
          "tbody",
          { role: "presentation" },
          p(Td, { dateProfile: e.dateProfile, cells: e.cells, renderRowIntro: e.renderRowIntro, showWeekNumbers: e.showWeekNumbers, clientWidth: e.clientWidth, clientHeight: e.clientHeight, businessHourSegs: e.businessHourSegs, bgEventSegs: e.bgEventSegs, fgEventSegs: e.fgEventSegs, dateSelectionSegs: e.dateSelectionSegs, eventSelection: e.eventSelection, eventDrag: e.eventDrag, eventResize: e.eventResize, dayMaxEvents: r, dayMaxEventRows: n, forPrint: e.forPrint, isHitComboAllowed: e.isHitComboAllowed })
        )
      )
    );
  }
  ...
  flushScrollReset() {
    if (this.needsScrollReset && this.props.clientWidth) {
      const e = xd(this.elRef.current, this.props.dateProfile);
      if (e) {
...
function xd(t, e) {
  let n;
  return e.currentRangeUnit.match(/year|month/) && (n = t.querySelector(`[data-date="${dl(e.currentDate)}-01"]`)), n || (n = t.querySelector(`[data-date="${Zt(e.currentDate)}"]`)), n;
}
class Od extends ma {
  constructor() {
...
class Qi {
  constructor(e) {
    this.subjectEl = null, this.selector = "", this.handleSelector = "", this.shouldIgnoreMove = !1, this.shouldWatchScroll = !0, this.isDragging = !1, this.isTouchDragging = !1, this.wasTouchScroll = !1, this.handleMouseDown = (n) => {
      if (!this.shouldIgnoreMouse() && Fd(n) && this.tryStart(n)) {
      ...
      if (this.isDragging) {
        let r = n.target;
        r.removeEventListener("touchmove", this.handleTouchMove), r.removeEventListener("touchend", this.handleTouchEnd), r.removeEventListener("touchcancel", this.handleTouchEnd), window.removeEventListener("scroll", this.handleTouchScroll, !0), this.emitter.trigger("pointerup", this.createEventFromTouch(n)), this.cleanup(), this.isTouchDragging = !1, Vd();
      }
    ...
    }, this.containerEl = e, this.emitter = new dt(), e.addEventListener("mousedown", this.handleMouseDown), e.addEventListener("touchstart", this.handleTouchStart, { passive: !0 }), zd();
  }
  destroy() {
    this.containerEl.removeEventListener("mousedown", this.handleMouseDown), this.containerEl.removeEventListener("touchstart", this.handleTouchStart, { passive: !0 }), Wd();
  }
  tryStart(e) {
  ...
  cleanup() {
    zt = !1, this.isDragging = !1, this.subjectEl = null, this.destroyScrollWatch();
  }
  querySubjectEl(e) {
    return this.selector ? P(e.target, this.selector) : this.containerEl;
  }
  shouldIgnoreMouse() {
    return Vt || this.isTouchDragging;
  }
  // can be called by user of this class, to cancel touch-based scrolling for the current drag
  cancelTouchScroll() {
    this.isDragging && (zt = !0);
  }
...
function Vd() {
  Vt += 1, setTimeout(() => {
    Vt -= 1;
  }, hn.touchMouseIgnoreWait);
}
function zd() {
  it += 1, it === 1 && window.addEventListener("touchmove", Yi, { passive: !1 });
}
function Wd() {
  it -= 1, it || window.removeEventListener("touchmove", Yi, { passive: !1 });
}
function Yi(t) {
  zt && t.preventDefault();
}
class Gd {
  ...
  cleanup() {
    this.mirrorEl && (Qt(this.mirrorEl), this.mirrorEl = null), this.sourceEl = null;
  }
  updateElPosition() {
  ...
  getMirrorEl() {
    ...
    return n || (n = this.mirrorEl = this.sourceEl.cloneNode(!0), n.style.userSelect = "none", n.style.webkitUserSelect = "none", n.style.pointerEvents = "none", n.classList.add("fc-event-dragging"), Ae(n, {
      position: "fixed",
      zIndex: this.zIndex,
      visibility: "",
...
class Yd {
  ...
  handleMove(e, n) {
    if (this.isEnabled) {
      ...
      s < 0 ? this.everMovedUp = !0 : s > 0 && (this.everMovedDown = !0), l < 0 ? this.everMovedLeft = !0 : l > 0 && (this.everMovedRight = !0), this.pointerScreenX = r, this.pointerScreenY = i, this.isAnimating || (this.isAnimating = !0, this.requestAnimation(mr()));
    }
  }
  stop() {
    if (this.isEnabled) {
  ...
  buildCaches(e) {
    return this.queryScrollEls(e).map((n) => n === window ? new Qd(!1) : new Zi(n, !1));
  }
  queryScrollEls(e) {
    let n = [];
...
class ke extends oa {
  constructor(e, n) {
    super(e), this.containerEl = e, this.delay = null, this.minDistance = 0, this.touchScrollAllowed = !0, this.mirrorNeedsRevert = !1, this.isInteracting = !1, this.isDragging = !1, this.isDelayEnded = !1, this.isDistanceSurpassed = !1, this.delayTimeoutId = null, this.onPointerDown = (i) => {
      this.isDragging || (this.isInteracting = !0, this.isDelayEnded = !1, this.isDistanceSurpassed = !1, Hs(document.body), Bs(document.body), i.isTouch || i.origEvent.preventDefault(), this.emitter.trigger("pointerdown", i), this.isInteracting && // not destroyed via pointerdown handler
      ...
      this.isInteracting && (this.isInteracting = !1, Ps(document.body), Ls(document.body), this.emitter.trigger("pointerup", i), this.isDragging && (this.autoScroller.stop(), this.tryStopDrag(i)), this.delayTimeoutId && (clearTimeout(this.delayTimeoutId), this.delayTimeoutId = null));
    };
    let r = this.pointer = new Qi(e);
    r.emitter.on("pointerdown", this.onPointerDown), r.emitter.on("pointermove", this.onPointerMove), r.emitter.on("pointerup", this.onPointerUp), n && (r.selector = n), this.mirror = new Gd(), this.autoScroller = new Yd();
  }
  destroy() {
...
class qd {
  constructor(e) {
    this.el = e, this.origRect = un(e), this.scrollCaches = bi(e).map((n) => new Zi(n, !0));
  }
  destroy() {
    for (let e of this.scrollCaches)
      e.destroy();
  ...
  isWithinClipping(e, n) {
    ...
    for (let i of this.scrollCaches)
      if (!Zd(i.getEventTarget()) && !Go(r, i.clientRect))
        return !1;
    return !0;
  }
}
...
class ft {
  ...
  processFirstCoord(e) {
    ...
    i instanceof HTMLElement && (s = un(i), r = Qo(r, s));
    ...
    if (l) {
      ...
      this.coordAdjust = qo(r, n);
    } else
      this.coordAdjust = { left: 0, top: 0 };
  }
  handleMove(e, n) {
    let r = this.queryHitForOffset(e.pageX + this.coordAdjust.left, e.pageY + this.coordAdjust.top);
    (n || !ht(this.movingHit, r)) && (this.movingHit = r, this.emitter.trigger("hitupdate", r, !1, e));
  }
  prepareHits() {
    this.offsetTrackers = oe(this.droppableStore, (e) => (e.component.prepareHits(), new qd(e.el)));
  }
  releaseHits() {
    ...
    for (let l in r) {
      ...
      a.isWithinClipping(e, n)) {
        ...
        if (
          ...
          at(v.dateProfile.activeRange, v.dateSpan.range) && // Ensure the component we are querying for the hit is accessibly my the pointer
          ...
          (this.disablePointCheck || a.el.contains(a.el.getRootNode().elementFromPoint(
            ...
            h + d - window.scrollX,
            f + c - window.scrollY
          ))) && (!s || v.layer > s.layer) && (v.componentId = l, v.context = o.context, v.rect.left += d, v.rect.right += d, v.rect.top += c, v.rect.bottom += c, s = v);
        }
      }
    }
    return s;
...
function ht(t, e) {
  return !t && !e ? !0 : !!t != !!e ? !1 : No(t.dateSpan, e.dateSpan);
}
function $i(t, e) {
  let n = {};
  for (let r of e.pluginHooks.datePointTransforms)
    Object.assign(n, r(t, e));
  return Object.assign(n, $d(t, e.dateEnv)), n;
}
function $d(t, e) {
  return {
  ...
  constructor(e) {
    super(e), this.handlePointerDown = (r) => {
      ...
      if (!s.wasTouchScroll) {
        ...
        if (l && o && ht(l, o)) {
          let { context: a } = i, d = Object.assign(Object.assign({}, $i(l.dateSpan, a)), { dayEl: l.dayEl, jsEvent: r.origEvent, view: a.viewApi || a.calendarApi.view });
          a.emitter.trigger("dateClick", d);
        }
      }
    }, this.dragging = new ke(e.el), this.dragging.autoScroller.isEnabled = !1;
    let n = this.hitDragging = new ft(this.dragging, cn(e));
...
class Jd extends Ee {
  constructor(e) {
    super(e), this.dragSelection = null, this.handlePointerDown = (l) => {
      ...
      a.setIgnoreMove(!c), a.delay = l.isTouch ? Kd(o) : null;
      ...
      if (l) {
        ...
        l.componentId === h.componentId && this.isHitComboAllowed && !this.isHitComboAllowed(h, l) || (d = eu(h, l, a.pluginHooks.dateSelectionTransformers)), (!d || !va(d, l.dateProfile, a)) && (c = !0, d = null);
      }
      d ? a.dispatch({ type: "SELECT_DATES", selection: d }) : o || a.dispatch({ type: "UNSELECT_DATES" }), c ? Yt() : qt(), o || (this.dragSelection = d);
    }, this.handlePointerUp = (l) => {
      this.dragSelection && (oi(this.dragSelection, l, this.component.context), this.dragSelection = null);
    };
    let { component: n } = e, { options: r } = n.context, i = this.dragging = new ke(e.el);
    i.touchScrollAllowed = !1, i.minDistance = r.selectMinDistance || 0, i.autoScroller.isEnabled = r.dragScroll;
    let s = this.hitDragging = new ft(this.dragging, cn(e));
...
class xe extends Ee {
  constructor(e) {
    super(e), this.subjectEl = null, this.subjectSeg = null, this.isDragging = !1, this.eventRange = null, this.relevantEvents = null, this.receivingContext = null, this.validMutation = null, this.mutatedRelevantEvents = null, this.handlePointerDown = (l) => {
      ...
      this.relevantEvents = sn(f.getCurrentData().eventStore, b), d.minDistance = l.isTouch ? 0 : h.eventDragMinDistance, d.delay = // only do a touch delay if touch and this event hasn't been selected yet
      l.isTouch && b !== a.props.eventSelection ? nu(a) : null, h.fixedMirrorParent ? c.parentNode = h.fixedMirrorParent : c.parentNode = P(o, ".fc"), c.revertDuration = h.dragRevertDuration;
      let v = a.isValidSegDownEl(o) && !P(o, ".fc-event-resizer");
      ...
      if (l) {
        h = l.context;
        let v = h.options;
        c === h || v.editable && v.droppable ? (f = tu(d, l, this.eventRange.instance.range.start, h.getCurrentData().pluginHooks.eventDragMutationMassagers), f && (u = an(a, h.getCurrentData().eventUiBases, f, h), b.mutatedEvents = u, Si(b, l.dateProfile, h) || (m = !0, f = null, u = null, b.mutatedEvents = U()))) : h = null;
      }
      this.displayDrag(h, b), m ? Yt() : qt(), o || (c === h && // TODO: write test for this
      ht(d, l) && (f = null), this.dragging.setMirrorNeedsRevert(!f), this.dragging.setMirrorIsVisible(!l || !this.subjectEl.getRootNode().querySelector(".fc-event-mirror")), this.receivingContext = h, this.validMutation = f, this.mutatedRelevantEvents = u);
      ...
      if (this.isDragging) {
        ...
        if (this.clearDrag(), o.emitter.trigger("eventDragStop", {
          ...
          if (d === o) {
            ...
            }), d.emitter.trigger("drop", Object.assign(Object.assign({}, $i(v.dateSpan, d)), { draggedEl: l.subjectEl, jsEvent: l.origEvent, view: v.context.viewApi })), d.emitter.trigger("eventReceive", Object.assign(Object.assign({}, H), { draggedEl: l.subjectEl, view: v.context.viewApi }));
          }
        } else
    ...
    let { component: n } = this, { options: r } = n.context, i = this.dragging = new ke(e.el);
    i.pointer.selector = xe.SELECTOR, i.touchScrollAllowed = !1, i.autoScroller.isEnabled = r.dragScroll;
    let s = this.hitDragging = new ft(this.dragging, Ut);
...
function tu(t, e, n, r) {
  ...
  i.allDay !== s.allDay && (a.allDay = s.allDay, a.hasEnd = e.context.options.allDayMaintainDuration, s.allDay ? l = R(n) : l = n);
  let d = he(l, o, t.context.dateEnv, t.componentId === e.componentId ? t.largeUnit : null);
...
class ru extends Ee {
  constructor(e) {
    super(e), this.draggingSegEl = null, this.draggingSeg = null, this.eventRange = null, this.relevantEvents = null, this.validMutation = null, this.mutatedRelevantEvents = null, this.handlePointerDown = (s) => {
      ...
      s && (s.componentId === c.componentId && this.isHitComboAllowed && !this.isHitComboAllowed(c, s) || (f = iu(c, s, o.subjectEl.classList.contains("fc-event-resizer-start"), h.range))), f && (u = an(d, a.getCurrentData().eventUiBases, f, a), b.mutatedEvents = u, Si(b, s.dateProfile, a) || (m = !0, f = null, u = null, b.mutatedEvents = null)), u ? a.dispatch({
        type: "SET_EVENT_RESIZE",
        state: b
      }) : a.dispatch({ type: "UNSET_EVENT_RESIZE" }), m ? Yt() : qt(), l || (f && ht(c, s) && (f = null), this.validMutation = f, this.mutatedRelevantEvents = u);
...
class su {
  constructor(e) {
    this.context = e, this.isRecentPointerDateSelect = !1, this.matchesCancel = !1, this.matchesEvent = !1, this.onSelect = (r) => {
      ...
      let i = this.context.options.unselectCancel, s = jr(r.origEvent);
      this.matchesCancel = !!P(s, i), this.matchesEvent = !!P(s, xe.SELECTOR);
    ...
    let n = this.documentPointer = new Qi(document);
...
var au = X({
  ...
  componentInteractions: [Xd, Jd, xe, ru],
  calendarInteractions: [su],
  elementDraggingImpl: ke,
  optionRefiners: lu,
  listenerRefiners: ou
});
const cu = /* @__PURE__ */ Xi({
  __name: "index",
  props: {
    local: {
      type: String,
  ...
  setup(t, { emit: e }) {
    const n = t, r = e, i = Ji(null), s = () => {
      let l = document.getElementById("calendar");
      l && (i.value && i.value.destroy(), i.value = new hd(l, {
        plugins: [
          jd,
          au
        ],
        ...
        eventClick: (o) => {
          r("eventClick", o), o.jsEvent.stopPropagation();
        },
        // 显示结束事件
    ...
    return Ki(() => {
      ...
      s();
    }, { deep: !0 }), (l, o) => (ns(), ts("div", null, [...o[0] || (o[0] = [
      rs(
        "div",
        { id: "calendar" },
        null,
